...
var t = () => {
  let t = document.querySelector(`[data-header]`);
  if (!t) return;
  let n = t.getAttribute(`data-scroll-reactive`) === `true`,
    r = t.querySelectorAll(`[data-dropdown-trigger]`),
    i = t.querySelectorAll(`[data-dropdown-panel-id]`),
    a = t.querySelector(`[data-dropdowns-container]`),
    o = document.querySelector(`[data-dropdown-overlay]`),
    s = t.querySelector(`[data-mobile-menu-toggle]`),
    c = t.querySelector(`[data-mobile-menu]`),
    l = t.querySelectorAll(`[data-mobile-dropdown-trigger]`),
    u = t.querySelectorAll(`[data-mobile-dropdown-panel]`),
    d = window.scrollY,
    f = !1,
    p = null;
  n &&
    window.addEventListener(`scroll`, () => {
      if (f || t.classList.contains(`menu-open`)) return;
      let e = window.scrollY;
      e > 0 ? t.classList.add(`scrolled`) : t.classList.remove(`scrolled`);
      let n = e - d;
      (n > 5 ? (t.classList.add(`hidden`), _(), g()) : n < -5 && t.classList.remove(`hidden`),
        Math.abs(n) > 5 && (d = e));
    });
  let m = t.querySelector(`[data-logo-link]`),
    h = t.querySelector(`[data-logo-context-menu]`),
    g = () => {
      h && (h.classList.remove(`visible`), h.setAttribute(`aria-hidden`, `true`));
    };
  if (m && h) {
    (m.addEventListener(`contextmenu`, (e) => {
      ...
      m.addEventListener(`click`, (e) => {
        h.classList.contains(`visible`) && e.preventDefault();
      }),
      window.addEventListener(`pointerdown`, (e) => {
        let t = e.target;
        h.contains(t) || m.contains(t) || g();
      }),
      window.addEventListener(`scroll`, g, { passive: !0 }),
      window.addEventListener(`keydown`, (e) => {
        e.key === `Escape` && g();
      }));
    let e = h.querySelector(`[data-context-action="copy-logo"]`),
      t = h.querySelector(`[data-context-action="copy-wordmark"]`),
      n = (e) => {
        (e.classList.add(`copied`),
          setTimeout(() => {
            (e.classList.remove(`copied`), g());
          }, 1200));
      };
    (e &&
      e.addEventListener(`click`, (t) => {
        (t.stopPropagation(),
          navigator.clipboard
            .writeText(
              `<svg viewBox="0 0 113 113" height="113" width="113" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <defs>
    ...
    <filter id="filter9_logo" x="-15.1522" y="-15.9493" width="77.2941" height="91.076" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
      ...
      t.addEventListener(`click`, (e) => {
        e.stopPropagation();
        let r = m.querySelector(`svg`)?.outerHTML || ``;
  ...
  (r.forEach((n) => {
    let r = n.getAttribute(`data-dropdown-trigger`),
      s = () => {
        if (!r) {
          _();
          return;
        ...
        ((p = r),
          ...
          i.forEach((e) => {
            (e.classList.remove(`open`),
              e.getAttribute(`data-dropdown-panel-id`) === r && e.classList.add(`open`));
          }),
          t.classList.add(`dropdown-open`),
          a.classList.add(`open`),
          o.classList.add(`open`));
        let n = a.querySelector(`[data-dropdown-panel-id="${r}"]`);
        if (n) {
          let t = n.querySelectorAll(`.dropdown-title, .dropdown-info, .nav-button`),
            r = n.querySelectorAll(`.subnav-link`);
          e.timeline()
            .set(t, { opacity: 0, y: `1em` })
            .to(a, { duration: 0.3, height: `auto`, opacity: 1, ease: `power2.out` })
            .to(t, { duration: 0.3, opacity: 1, y: 0, stagger: 0.08, ease: `power2.out` }, `<`)
            .fromTo(
              r,
              { y: `1em`, opacity: 0 },
  ...
  function _() {
    ((p = null),
      ...
      i.forEach((e) => e.classList.remove(`open`)));
  }
  s &&
    s.addEventListener(`click`, (e) => {
      if ((e.stopPropagation(), (f = !f), f)) {
        (t.classList.remove(`hidden`),
          t.classList.add(`menu-open`),
          c.classList.add(`open`),
          document.body.classList.add(`no-scroll`));
        let e = s.querySelector(`span`);
        (e && (e.textContent = `close`), g());
      } else v();
    });
  function v() {
    if (
      ...
      let e = s.querySelector(`span`);
      e && (e.textContent = `menu`);
    }
    (u.forEach((e) => e.classList.remove(`open`)), l.forEach((e) => e.classList.remove(`open`)));
  }
  (l.forEach((e) => {
    let t = e.getAttribute(`data-mobile-dropdown-trigger`);
    e.addEventListener(`click`, (n) => {
      n.stopPropagation();
      let r = c.querySelector(`[data-mobile-dropdown-panel="${t}"]`);
      if (r) {
    ...
    t.querySelectorAll(`.nav a, .mobile-menu a, .dropdown a, [data-logo-link]`).forEach((e) => {
