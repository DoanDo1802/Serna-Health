...
var U = class e {
  ...
  W = class e {
    ...
    applyAxisAngle(e, t) {
      return this.applyQuaternion(rt.setFromAxisAngle(e, t));
    }
    applyMatrix3(e) {
      let t = this.x,
        n = this.y,
    ...
    clamp(e, t) {
      return (
        (this.x = H(this.x, e.x, t.x)),
        (this.y = H(this.y, e.y, t.y)),
        (this.z = H(this.z, e.z, t.z)),
        this
      );
    }
    clampScalar(e, t) {
      ...
      convert: function (e, t, n) {
        return this.enabled === !1 || t === n || !t || !n
          ...
          : (this.spaces[t].transfer === `srgb` &&
              ((e.r = mt(e.r)), (e.g = mt(e.g)), (e.b = mt(e.b))),
            ...
            this.spaces[n].transfer === `srgb` &&
              ((e.r = ht(e.r)), (e.g = ht(e.g)), (e.b = ht(e.b))),
            e);
      },
  ...
  _t = class {
    static getDataURL(e, t = `image/png`) {
      ...
      if (e instanceof HTMLCanvasElement) n = e;
        ...
        (gt === void 0 && (gt = ot(`canvas`)), (gt.width = e.width), (gt.height = e.height));
      ...
      if (r !== null) {
        ...
        if (Array.isArray(r)) {
          ...
          for (let t = 0, n = r.length; t < n; t++)
            r[t].isDataTexture ? e.push(bt(r[t].image)) : e.push(bt(r[t]));
        } else e = bt(r);
        n.url = e;
      }
...
var wt = class e {
  ...
  Tt = class extends Ke {
    constructor(e = 1, t = 1, n = {}) {
      ...
      let r = new Ct({ width: e, height: t, depth: n.depth });
      this.textures = [];
      let i = n.count;
      for (let e = 0; e < i; e++)
    ...
    _setTextureOptions(e = {}) {
      let t = { minFilter: h, generateMipmaps: !1, flipY: !1, internalFormat: null };
  ...
  kt = class {
    ...
    setFromCenterAndSize(e, t) {
      let n = jt.copy(t).multiplyScalar(0.5);
      ...
      if (n !== void 0) {
        ...
        if (t === !0 && r !== void 0 && e.isInstancedMesh !== !0)
          for (let t = 0, n = r.count; t < n; t++)
            (e.isMesh === !0 ? e.getVertexPosition(t, jt) : jt.fromBufferAttribute(r, t),
              jt.applyMatrix4(e.matrixWorld),
              this.expandByPoint(jt));
        else
          (e.boundingBox === void 0
            ? (n.boundingBox === null && n.computeBoundingBox(), Mt.copy(n.boundingBox))
            : (e.boundingBox === null && e.computeBoundingBox(), Mt.copy(e.boundingBox)),
    ...
    intersectsTriangle(e) {
      ...
      (this.getCenter(zt),
        ...
        Nt.subVectors(e.a, zt),
        Pt.subVectors(e.b, zt),
        Ft.subVectors(e.c, zt),
        It.subVectors(Pt, Nt),
        Lt.subVectors(Ft, Pt),
        Rt.subVectors(Nt, Ft));
      let t = [
      ...
      return !Ut(t, Nt, Pt, Ft, Bt) || ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !Ut(t, Nt, Pt, Ft, Bt))
        ? !1
        : (Vt.crossVectors(It, Lt), (t = [Vt.x, Vt.y, Vt.z]), Ut(t, Nt, Pt, Ft, Bt));
    }
    clampPoint(e, t) {
    ...
    getBoundingSphere(e) {
      return (
        this.isEmpty()
          ? e.makeEmpty()
          : (this.getCenter(e.center), (e.radius = this.getSize(jt).length() * 0.5)),
        e
      );
    }
    intersect(e) {
    ...
    applyMatrix4(e) {
      return this.isEmpty()
        ? this
        : (At[0].set(this.min.x, this.min.y, this.min.z).applyMatrix4(e),
          At[1].set(this.min.x, this.min.y, this.max.z).applyMatrix4(e),
          At[2].set(this.min.x, this.max.y, this.min.z).applyMatrix4(e),
          At[3].set(this.min.x, this.max.y, this.max.z).applyMatrix4(e),
          At[4].set(this.max.x, this.min.y, this.min.z).applyMatrix4(e),
          At[5].set(this.max.x, this.min.y, this.max.z).applyMatrix4(e),
          At[6].set(this.max.x, this.max.y, this.min.z).applyMatrix4(e),
          At[7].set(this.max.x, this.max.y, this.max.z).applyMatrix4(e),
  ...
  At = [new W(), new W(), new W(), new W(), new W(), new W(), new W(), new W()],
  jt = new W(),
  Mt = new kt(),
  Nt = new W(),
  Pt = new W(),
...
function Ut(e, t, n, r, i) {
  for (let a = 0, o = e.length - 3; a <= o; a += 3) {
    Ht.fromArray(e, a);
    let o = i.x * Math.abs(Ht.x) + i.y * Math.abs(Ht.y) + i.z * Math.abs(Ht.z),
      s = t.dot(Ht),
      c = n.dot(Ht),
      l = r.dot(Ht);
...
var Wt = new kt(),
  ...
  qt = class {
    ...
    setFromPoints(e, t) {
      let n = this.center;
      t === void 0 ? Wt.setFromPoints(e).getCenter(n) : n.copy(t);
      let r = 0;
    ...
    expandByPoint(e) {
      ...
      Gt.subVectors(e, this.center);
      let t = Gt.lengthSq();
      if (t > this.radius * this.radius) {
        let e = Math.sqrt(t),
          n = (e - this.radius) * 0.5;
        (this.center.addScaledVector(Gt, n / e), (this.radius += n));
      }
      return this;
    }
    union(e) {
      return e.isEmpty()
        ...
        : this.isEmpty()
          ...
          : (this.center.equals(e.center) === !0
              ...
              : (Kt.subVectors(e.center, this.center).setLength(e.radius),
                this.expandByPoint(Gt.copy(e.center).add(Kt)),
                this.expandByPoint(Gt.copy(e.center).sub(Kt))),
            this);
    }
    equals(e) {
  ...
  tn = class {
    ...
    distanceSqToPoint(e) {
      ...
      return t < 0
        ...
        : (Jt.copy(this.origin).addScaledVector(this.direction, t), Jt.distanceToSquared(e));
    }
    distanceSqToSegment(e, t, n, r) {
      (Yt.copy(e).add(t).multiplyScalar(0.5),
        Xt.copy(t).sub(e).normalize(),
        Zt.copy(this.origin).sub(Yt));
      let i = e.distanceTo(t) * 0.5,
        a = -this.direction.dot(Xt),
      ...
      return (
        ...
        r && r.copy(Yt).addScaledVector(Xt, d),
        f
      );
    }
    intersectSphere(e, t) {
      Jt.subVectors(e.center, this.origin);
      let n = Jt.dot(this.direction),
        r = Jt.dot(Jt) - n * n,
        i = e.radius * e.radius;
      if (r > i) return null;
      let a = Math.sqrt(i - r),
    ...
    intersectTriangle(e, t, n, r, i) {
      (Qt.subVectors(t, e), $t.subVectors(n, e), en.crossVectors(Qt, $t));
      let a = this.direction.dot(en),
        o;
      if (a > 0) {
        if (r) return null;
        o = 1;
      ...
      let s = o * this.direction.dot($t.crossVectors(Zt, $t));
      if (s < 0) return null;
      let c = o * this.direction.dot(Qt.cross(Zt));
  ...
  nn = class e {
    ...
    extractRotation(e) {
      let t = this.elements,
        n = e.elements,
        r = 1 / rn.setFromMatrixColumn(e, 0).length(),
        i = 1 / rn.setFromMatrixColumn(e, 1).length(),
        a = 1 / rn.setFromMatrixColumn(e, 2).length();
      return (
        (t[0] = n[0] * r),
        (t[1] = n[1] * r),
        (t[2] = n[2] * r),
    ...
    lookAt(e, t, n) {
      ...
      return (
        ...
        un.normalize(),
        cn.crossVectors(n, un),
        cn.lengthSq() === 0 &&
          (Math.abs(n.z) === 1 ? (un.x += 1e-4) : (un.z += 1e-4),
          un.normalize(),
          cn.crossVectors(n, un)),
        cn.normalize(),
        ln.crossVectors(un, cn),
        (r[0] = cn.x),
        (r[4] = ln.x),
        (r[8] = un.x),
        (r[1] = cn.y),
    ...
    multiplyMatrices(e, t) {
      let n = e.elements,
        ...
        P = r[15];
      return (
        (i[0] = a * x + o * T + s * k + c * te),
        (i[4] = a * S + o * E + s * A + c * M),
        (i[8] = a * C + o * D + s * j + c * N),
        (i[12] = a * w + o * O + s * ee + c * P),
        (i[1] = l * x + u * T + d * k + f * te),
        (i[5] = l * S + u * E + d * A + f * M),
        (i[9] = l * C + u * D + d * j + f * N),
        (i[13] = l * w + u * O + d * ee + f * P),
        (i[2] = p * x + m * T + h * k + g * te),
        (i[6] = p * S + m * E + h * A + g * M),
        (i[10] = p * C + m * D + h * j + g * N),
        (i[14] = p * w + m * O + h * ee + g * P),
        (i[3] = _ * x + v * T + y * k + b * te),
        (i[7] = _ * S + v * E + y * A + b * M),
        (i[11] = _ * C + v * D + y * j + b * N),
        (i[15] = _ * w + v * O + y * ee + b * P),
        this
      );
    }
    multiplyScalar(e) {
    ...
    decompose(e, t, n) {
      let r = this.elements,
        i = rn.set(r[0], r[1], r[2]).length(),
        a = rn.set(r[4], r[5], r[6]).length(),
        o = rn.set(r[8], r[9], r[10]).length();
...
var mn = class {
  ...
  En = { type: `added` },
  Dn = { type: `removed` },
  On = { type: `childadded`, child: null },
  kn = { type: `childremoved`, child: null },
  An = class e extends Ke {
    ...
    translateOnAxis(e, t) {
      return (
        gn.copy(e).applyQuaternion(this.quaternion),
        this.position.add(gn.multiplyScalar(t)),
        this
      );
    }
    translateX(e) {
    ...
    lookAt(e, t, n) {
      ...
      (this.updateWorldMatrix(!0, !1),
        bn.setFromMatrixPosition(this.matrixWorld),
        this.isCamera || this.isLight ? vn.lookAt(bn, yn, this.up) : vn.lookAt(yn, bn, this.up),
        this.quaternion.setFromRotationMatrix(vn),
        r &&
          (vn.extractRotation(r.matrixWorld),
          _n.setFromRotationMatrix(vn),
          this.quaternion.premultiply(_n.invert())));
    }
    add(e) {
...
var jn = new W(),
  ...
  Wn = class e {
    ...
    static containsPoint(e, t, n, r) {
      return (
        this.getBarycoord(e, t, n, r, Pn) !== null && Pn.x >= 0 && Pn.y >= 0 && Pn.x + Pn.y <= 1
      );
    }
    static getInterpolation(e, t, n, r, i, a, o, s) {
      return this.getBarycoord(e, t, n, r, Pn) === null
        ? ((s.x = 0), (s.y = 0), `z` in s && (s.z = 0), `w` in s && (s.w = 0), null)
        : (s.setScalar(0),
          s.addScaledVector(i, Pn.x),
          s.addScaledVector(a, Pn.y),
    ...
    static getInterpolatedAttribute(e, t, n, r, i, a) {
      return (
        ...
        Hn.setScalar(0),
        Un.setScalar(0),
        Vn.fromBufferAttribute(e, t),
        Hn.fromBufferAttribute(e, n),
        Un.fromBufferAttribute(e, r),
        a.setScalar(0),
        a.addScaledVector(Vn, i.x),
        a.addScaledVector(Hn, i.y),
        a.addScaledVector(Un, i.z),
        a
      );
    }
    ...
    getArea() {
      return (
        jn.subVectors(this.c, this.b),
        Mn.subVectors(this.a, this.b),
        jn.cross(Mn).length() * 0.5
      );
    }
    getMidpoint(e) {
      return e
...
var q = class {
    ...
    setHSL(e, t, n, r = K.workingColorSpace) {
      if (((e = Ze(e, 1)), (t = H(t, 0, 1)), (n = H(n, 0, 1)), t === 0))
        this.r = this.g = this.b = n;
      else {
        let r = n <= 0.5 ? n * (1 + t) : n + t - n * t,
          i = 2 * n - r;
        ((this.r = Jn(i, r, e + 1 / 3)), (this.g = Jn(i, r, e)), (this.b = Jn(i, r, e - 1 / 3)));
      }
    ...
    setColorName(e, t = ze) {
      let n = Gn[e.toLowerCase()];
      return (
        n === void 0 ? console.warn(`THREE.Color: Unknown color ` + e) : this.setHex(n, t),
        this
      );
    }
    clone() {
    ...
    getHex(e = ze) {
      return (
        K.workingToColorSpace(Yn.copy(this), e),
        Math.round(H(Yn.r * 255, 0, 255)) * 65536 +
          Math.round(H(Yn.g * 255, 0, 255)) * 256 +
          Math.round(H(Yn.b * 255, 0, 255))
      );
    }
    getHexString(e = ze) {
    ...
    getHSL(e, t = K.workingColorSpace) {
      K.workingToColorSpace(Yn.copy(this), t);
      let n = Yn.r,
        r = Yn.g,
        i = Yn.b,
        a = Math.max(n, r, i),
    ...
    getRGB(e, t = K.workingColorSpace) {
      return (K.workingToColorSpace(Yn.copy(this), t), (e.r = Yn.r), (e.g = Yn.g), (e.b = Yn.b), e);
    }
    getStyle(e = ze) {
      K.workingToColorSpace(Yn.copy(this), e);
      let t = Yn.r,
    ...
    lerpHSL(e, t) {
      (this.getHSL(Kn), e.getHSL(qn));
      let n = Qe(Kn.h, qn.h, t),
        r = Qe(Kn.s, qn.s, t),
        i = Qe(Kn.l, qn.l, t);
...
var Xn = 0,
  ...
  nr = class {
    ...
    applyMatrix3(e) {
      if (this.itemSize === 2)
        ...
        for (let t = 0, n = this.count; t < n; t++)
          ($n.fromBufferAttribute(this, t), $n.applyMatrix3(e), this.setXYZ(t, $n.x, $n.y, $n.z));
      return this;
    }
    applyMatrix4(e) {
      for (let t = 0, n = this.count; t < n; t++)
        ($n.fromBufferAttribute(this, t), $n.applyMatrix4(e), this.setXYZ(t, $n.x, $n.y, $n.z));
      return this;
    }
    applyNormalMatrix(e) {
      for (let t = 0, n = this.count; t < n; t++)
    ...
    setXYZ(e, t, n, r) {
      return (
        (e *= this.itemSize),
        this.normalized &&
          ((t = et(t, this.array)), (n = et(n, this.array)), (r = et(r, this.array))),
        (this.array[e + 0] = t),
        (this.array[e + 1] = n),
        (this.array[e + 2] = r),
        this
  ...
  pr = class e extends Ke {
    ...
    setIndex(e) {
      return (
        Array.isArray(e) ? (this.index = new (at(e) ? ir : rr)(e, 1)) : (this.index = e),
        this
      );
    }
    setIndirect(e) {
      ...
      if (e !== void 0) {
        if ((this.boundingBox.setFromBufferAttribute(e), t))
          for (let e = 0, n = t.length; e < n; e++) {
            let n = t[e];
            (ur.setFromBufferAttribute(n),
              this.morphTargetsRelative
                ? (fr.addVectors(this.boundingBox.min, ur.min),
                  this.boundingBox.expandByPoint(fr),
                  fr.addVectors(this.boundingBox.max, ur.max),
                  this.boundingBox.expandByPoint(fr))
                : (this.boundingBox.expandByPoint(ur.min), this.boundingBox.expandByPoint(ur.max)));
          }
    ...
    computeBoundingSphere() {
      ...
      if (e) {
        ...
        if ((ur.setFromBufferAttribute(e), t))
          for (let e = 0, n = t.length; e < n; e++) {
            let n = t[e];
            (dr.setFromBufferAttribute(n),
              this.morphTargetsRelative
                ? (fr.addVectors(ur.min, dr.min),
                  ur.expandByPoint(fr),
                  fr.addVectors(ur.max, dr.max),
                  ur.expandByPoint(fr))
        ...
        for (let t = 0, i = e.count; t < i; t++)
          (fr.fromBufferAttribute(e, t), (r = Math.max(r, n.distanceToSquared(fr))));
        if (t)
          for (let i = 0, a = t.length; i < a; i++) {
            let a = t[i],
              o = this.morphTargetsRelative;
            for (let t = 0, i = a.count; t < i; t++)
              (fr.fromBufferAttribute(a, t),
                o && (lr.fromBufferAttribute(e, t), fr.add(lr)),
                (r = Math.max(r, n.distanceToSquared(fr))));
          }
    ...
    computeTangents() {
      ...
      this.hasAttribute(`tangent`) === !1 &&
        this.setAttribute(`tangent`, new nr(new Float32Array(4 * n.count), 4));
    ...
    computeVertexNormals() {
      ...
      if (t !== void 0) {
        ...
        if (n === void 0)
          ((n = new nr(new Float32Array(t.count * 3), 3)), this.setAttribute(`normal`, n));
    ...
    normalizeNormals() {
      ...
      for (let t = 0, n = e.count; t < n; t++)
        (fr.fromBufferAttribute(e, t), fr.normalize(), e.setXYZ(t, fr.x, fr.y, fr.z));
    }
    toNonIndexed() {
      function t(e, t) {
        let n = e.array,
  ...
  Tr = class extends An {
      ...
      if (i && o) {
        ...
        for (let n = 0, r = i.length; n < r; n++) {
          ...
          r !== 0 &&
            ...
            a ? Sr.addScaledVector(xr, r) : Sr.addScaledVector(xr.sub(t), r));
        }
        t.add(Sr);
      }
      return t;
    ...
    raycast(e, t) {
      ...
      r !== void 0 &&
        ...
        gr.applyMatrix4(i),
        hr.copy(e.ray).recast(e.near),
        !(
          gr.containsPoint(hr.origin) === !1 &&
          (hr.intersectSphere(gr, _r) === null ||
            hr.origin.distanceToSquared(_r) > (e.far - e.near) ** 2)
        ) &&
          (mr.copy(i).invert(),
          hr.copy(e.ray).applyMatrix4(mr),
          !(n.boundingBox !== null && hr.intersectsBox(n.boundingBox) === !1) &&
            this._computeIntersections(e, t, hr)));
    }
...
function Er(e, t, n, r, i, a, o, s) {
  ...
  let l = n.ray.origin.distanceTo(wr);
  return l < n.near || l > n.far ? null : { distance: l, point: wr.clone(), object: e };
}
function Dr(e, t, n, r, i, a, o, s, c, l) {
  (e.getVertexPosition(s, vr), e.getVertexPosition(c, yr), e.getVertexPosition(l, br));
  let u = Er(e, t, n, r, vr, yr, br, Cr);
  if (u) {
    let e = new W();
    (Wn.getBarycoord(Cr, vr, yr, br, e),
      i && (u.uv = Wn.getInterpolatedAttribute(i, s, c, l, e, new U())),
      a && (u.uv1 = Wn.getInterpolatedAttribute(a, s, c, l, e, new U())),
      o &&
        ((u.normal = Wn.getInterpolatedAttribute(o, s, c, l, e, new W())),
        u.normal.dot(r.direction) > 0 && u.normal.multiplyScalar(-1)));
    let t = { a: s, b: c, c: l, normal: new W(), materialIndex: 0 };
    (Wn.getNormal(vr, yr, br, t.normal), (u.face = t), (u.barycoord = e));
  }
  return u;
}
var Or = class e extends pr {
  constructor(e = 1, t = 1, n = 1, r = 1, i = 1, a = 1) {
    ...
    (p(`z`, `y`, `x`, -1, -1, n, t, e, a, i, 0),
      ...
      this.setIndex(s),
      this.setAttribute(`position`, new ar(c, 3)),
      this.setAttribute(`normal`, new ar(l, 3)),
      this.setAttribute(`uv`, new ar(u, 2)));
...
var Nr = { clone: kr, merge: Ar },
  ...
  Ir = class extends Zn {
    ...
    copy(e) {
      return (
        ...
        (this.uniformsGroups = jr(e.uniformsGroups)),
  ...
  Vr = class extends Lr {
    ...
    getFocalLength() {
      let e = Math.tan(Je * 0.5 * this.fov);
    ...
    updateProjectionMatrix() {
      let e = this.near,
        t = (e * Math.tan(Je * 0.5 * this.fov)) / this.zoom,
        n = 2 * t,
        r = this.aspect * n,
        i = -0.5 * r,
        a = this.view;
  ...
  Wr = class extends An {
    constructor(e, t, n) {
      ...
      let r = new Vr(Hr, Ur, e, t);
      ((r.layers = this.layers), this.add(r));
      let i = new Vr(Hr, Ur, e, t);
      ((i.layers = this.layers), this.add(i));
      let a = new Vr(Hr, Ur, e, t);
      ((a.layers = this.layers), this.add(a));
      let o = new Vr(Hr, Ur, e, t);
      ((o.layers = this.layers), this.add(o));
      let s = new Vr(Hr, Ur, e, t);
      ((s.layers = this.layers), this.add(s));
      let c = new Vr(Hr, Ur, e, t);
  ...
  Kr = class extends Et {
    ...
    fromEquirectangularTexture(e, t) {
      ...
      let a = new Tr(r, i),
        o = t.minFilter;
      return (
        t.minFilter === 1008 && (t.minFilter = h),
        new Wr(1, 10, this).update(e, a),
        (t.minFilter = o),
        a.geometry.dispose(),
        a.material.dispose(),
        this
  ...
  ai = class {
    ...
    intersectsSprite(e) {
      return (
        ni.center.set(0, 0, 0),
        (ni.radius = 0.7071067811865476 + ri.distanceTo(e.center)),
    ...
    intersectsBox(e) {
      ...
      for (let n = 0; n < 6; n++) {
        let r = t[n];
        if (
          ((ii.x = r.normal.x > 0 ? e.max.x : e.min.x),
          (ii.y = r.normal.y > 0 ? e.max.y : e.min.y),
          (ii.z = r.normal.z > 0 ? e.max.z : e.min.z),
  ...
  di = class extends An {
    ...
    raycast(e, t) {
      ...
      if (
        ...
        li.applyMatrix4(r),
        (li.radius += i),
        e.ray.intersectsSphere(li) === !1)
      )
        return;
      (si.copy(r).invert(), ci.copy(e.ray).applyMatrix4(si));
      ...
      if (c !== null) {
        ...
        for (let a = n, o = i; a < o; a++) {
          let n = c.getX(a);
          (ui.fromBufferAttribute(l, n), fi(ui, n, s, r, e, t, this));
        }
      } else {
        let n = Math.max(0, a.start),
          i = Math.min(l.count, a.start + a.count);
        for (let a = n, o = i; a < o; a++)
          (ui.fromBufferAttribute(l, a), fi(ui, a, s, r, e, t, this));
      }
    }
    updateMorphTargets() {
      let e = this.geometry.morphAttributes,
...
function fi(e, t, n, r, i, a, o) {
  let s = ci.distanceSqToPoint(e);
  if (s < n) {
    let n = new W();
    (ci.closestPointToPoint(e, n), n.applyMatrix4(r));
...
var pi = class extends Ct {
    constructor(e, t, n = C, r, i, a, o = f, s = f, c, l = M, u = 1) {
      if (l !== 1026 && l !== 1027)
        throw Error(
          `DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat`
        );
      (super({ width: e, height: t, depth: u }, r, i, a, o, s, l, n, c),
    ...
    copy(e) {
      return (
        super.copy(e),
        (this.source = new yt(Object.assign({}, e.image))),
...
var bi = class {
  ...
  wi = class {
    constructor(e, t, n, r) {
      ...
      ((this.name = e),
        (this.times = vi(t, this.TimeBufferType)),
        (this.values = vi(n, this.ValueBufferType)),
    ...
    static toJSON(e) {
      ...
      if (t.toJSON !== this.toJSON) n = t.toJSON(e);
        ...
        n = { name: e.name, times: vi(e.times, Array), values: vi(e.values, Array) };
...
((Ti.prototype.ValueTypeName = `bool`),
  ...
  (Ti.prototype.DefaultInterpolation = je),
...
((Ai.prototype.ValueTypeName = `string`),
  ...
  (Ai.prototype.DefaultInterpolation = je),
...
var Pi = class extends Lr {
  ...
  Bi = `[^` + Li.replace(`\\.`, ``) + `]`,
  Vi = `((?:WC+[\\/:])*)`.replace(`WC`, zi),
  Hi = `(WCOD+)?`.replace(`WCOD`, Bi),
  Ui = `(?:\\.(WC+)(?:\\[(.+)\\])?)?`.replace(`WC`, zi),
  Wi = `\\.(WC+)(?:\\[(.+)\\])?`.replace(`WC`, zi),
  Gi = RegExp(`^` + Vi + Hi + Ui + Wi + `$`),
  Ki = [`material`, `materials`, `bones`, `map`],
  qi = class {
    constructor(e, t, n) {
      let r = n || J.parseTrackName(t);
  ...
  J = class e {
    ...
    static parseTrackName(e) {
      ...
      if (r !== void 0 && r !== -1) {
        ...
        Ki.indexOf(e) !== -1 && ((n.nodeName = n.nodeName.substring(0, r)), (n.objectName = e));
      }
...
((J.Composite = qi),
  (J.prototype.BindingType = { Direct: 0, EntireArray: 1, ArrayElement: 2, HasFromToArray: 3 }),
  (J.prototype.Versioning = { None: 0, NeedsUpdate: 1, MatrixWorldNeedsUpdate: 2 }),
...
var Ji = new nn(),
  Yi = class {
    ...
    setFromXRController(e) {
      return (
        Ji.identity().extractRotation(e.matrixWorld),
        this.ray.origin.setFromMatrixPosition(e.matrixWorld),
        this.ray.direction.set(0, 0, -1).applyMatrix4(Ji),
        this
      );
    }
    intersectObject(e, t = !0, n = []) {
      return (Zi(e, this, n, t), n.sort(Xi), n);
    }
    intersectObjects(e, t = !0, n = []) {
      for (let r = 0, i = e.length; r < i; r++) Zi(e[r], this, n, t);
      return (n.sort(Xi), n);
    }
  };
function Xi(e, t) {
...
function Zi(e, t, n, r) {
  ...
  if ((e.layers.test(t.layers) && e.raycast(t, n) === !1 && (i = !1), i === !0 && r === !0)) {
    let r = e.children;
    for (let e = 0, i = r.length; e < i; e++) Zi(r[e], t, n, !0);
  }
}
function Qi(e, t, n, r) {
  let i = $i(r);
...
(typeof __THREE_DEVTOOLS__ < `u` &&
  __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`register`, { detail: { revision: `180` } })),
  typeof window < `u` &&
    (window.__THREE__
...
void main() {
  ...
  X = {
    common: {
      diffuse: { value: new q(16777215) },
      opacity: { value: 1 },
      map: { value: null },
      mapTransform: { value: new G() },
      alphaMap: { value: null },
      alphaMapTransform: { value: new G() },
      alphaTest: { value: 0 },
    },
    specularmap: { specularMap: { value: null }, specularMapTransform: { value: new G() } },
    envmap: {
      envMap: { value: null },
      envMapRotation: { value: new G() },
      flipEnvMap: { value: -1 },
    ...
    aomap: {
      ...
      aoMapTransform: { value: new G() },
    },
    lightmap: {
      lightMap: { value: null },
      lightMapIntensity: { value: 1 },
      lightMapTransform: { value: new G() },
    },
    bumpmap: {
      bumpMap: { value: null },
      bumpMapTransform: { value: new G() },
      bumpScale: { value: 1 },
    },
    normalmap: {
      normalMap: { value: null },
      normalMapTransform: { value: new G() },
      normalScale: { value: new U(1, 1) },
    },
    displacementmap: {
      displacementMap: { value: null },
      displacementMapTransform: { value: new G() },
      displacementScale: { value: 1 },
      displacementBias: { value: 0 },
    },
    emissivemap: { emissiveMap: { value: null }, emissiveMapTransform: { value: new G() } },
    metalnessmap: { metalnessMap: { value: null }, metalnessMapTransform: { value: new G() } },
    roughnessmap: { roughnessMap: { value: null }, roughnessMapTransform: { value: new G() } },
  ...
  na = {
    basic: {
      uniforms: Ar([X.common, X.specularmap, X.envmap, X.aomap, X.lightmap, X.fog]),
    ...
    depth: {
      uniforms: Ar([X.common, X.displacementmap]),
    ...
    backgroundCube: {
      uniforms: {
        ...
        backgroundIntensity: { value: 1 },
        backgroundRotation: { value: new G() },
      },
    ...
    shadow: {
      uniforms: Ar([X.lights, X.fog, { color: { value: new q(0) }, opacity: { value: 1 } }]),
...
na.physical = {
  uniforms: Ar([
    na.standard.uniforms,
    {
      ...
      clearcoatMapTransform: { value: new G() },
      clearcoatNormalMap: { value: null },
      clearcoatNormalMapTransform: { value: new G() },
      clearcoatNormalScale: { value: new U(1, 1) },
      clearcoatRoughness: { value: 0 },
      clearcoatRoughnessMap: { value: null },
      clearcoatRoughnessMapTransform: { value: new G() },
      dispersion: { value: 0 },
      iridescence: { value: 0 },
      iridescenceMap: { value: null },
      iridescenceMapTransform: { value: new G() },
      iridescenceIOR: { value: 1.3 },
      iridescenceThicknessMinimum: { value: 100 },
      iridescenceThicknessMaximum: { value: 400 },
      iridescenceThicknessMap: { value: null },
      iridescenceThicknessMapTransform: { value: new G() },
      sheen: { value: 0 },
      sheenColor: { value: new q(0) },
      sheenColorMap: { value: null },
      sheenColorMapTransform: { value: new G() },
      sheenRoughness: { value: 1 },
      sheenRoughnessMap: { value: null },
      sheenRoughnessMapTransform: { value: new G() },
      transmission: { value: 0 },
      transmissionMap: { value: null },
      transmissionMapTransform: { value: new G() },
      transmissionSamplerSize: { value: new U() },
      transmissionSamplerMap: { value: null },
      thickness: { value: 0 },
      thicknessMap: { value: null },
      thicknessMapTransform: { value: new G() },
      attenuationDistance: { value: 0 },
      attenuationColor: { value: new q(0) },
      specularColor: { value: new q(1, 1, 1) },
      specularColorMap: { value: null },
      specularColorMapTransform: { value: new G() },
      specularIntensity: { value: 1 },
      specularIntensityMap: { value: null },
      specularIntensityMapTransform: { value: new G() },
      anisotropyVector: { value: new U() },
      anisotropyMap: { value: null },
      anisotropyMapTransform: { value: new G() },
    },
  ]),
  vertexShader: Y.meshphysical_vert,
  fragmentShader: Y.meshphysical_frag,
...
function oa(e, t, n, r, i, a, o) {
  ...
  function g(t, n) {
    ...
    r && (r.isCubeTexture || r.mapping === 306)
      ? (u === void 0 &&
          ((u = new Tr(
            ...
            new Ir({
              ...
              uniforms: kr(na.backgroundCube.uniforms),
          ...
          i.update(u)),
        ia.copy(n.backgroundRotation),
        (ia.x *= -1),
        (ia.y *= -1),
        (ia.z *= -1),
        r.isCubeTexture && r.isRenderTargetTexture === !1 && ((ia.y *= -1), (ia.z *= -1)),
        ...
        u.material.uniforms.backgroundRotation.value.setFromMatrix4(aa.makeRotationFromEuler(ia)),
        (u.material.toneMapped = K.getTransfer(r.colorSpace) !== He),
      ...
      : r &&
        ...
        (l === void 0 &&
          ((l = new Tr(
            ...
            new Ir({
              ...
              uniforms: kr(na.background.uniforms),
        ...
        (l.material.toneMapped = K.getTransfer(r.colorSpace) !== He),
  ...
  function _(t, n) {
    (t.getRGB(ra, Mr(e)), r.buffers.color.setClear(ra.r, ra.g, ra.b, n, o));
  }
  function v() {
...
function la(e, t, n, r) {
  ...
  let d = n.logarithmicDepthBuffer === !0,
    ...
    x = m > 0,
    S = e.getParameter(e.MAX_SAMPLES);
  return {
    isWebGL2: !0,
    getMaxAnisotropy: a,
    getMaxPrecision: c,
  ...
  Ta = class {
    ...
    fromScene(e, t = 0, n = 0.1, r = 100, i = {}) {
      ...
      ((_a = this._renderer.getRenderTarget()),
        (va = this._renderer.getActiveCubeFace()),
        (ya = this._renderer.getActiveMipmapLevel()),
        (ba = this._renderer.xr.enabled),
    ...
    compileCubemapShader() {
      this._cubemapMaterial === null &&
        ((this._cubemapMaterial = ja()), this._compileMaterial(this._cubemapMaterial));
    }
    compileEquirectangularShader() {
      this._equirectMaterial === null &&
        ((this._equirectMaterial = Aa()), this._compileMaterial(this._equirectMaterial));
    }
    dispose() {
      (this._dispose(),
    ...
    _cleanup(e) {
      (this._renderer.setRenderTarget(_a, va, ya),
        (this._renderer.xr.enabled = ba),
        (e.scissorTest = !1),
    ...
    _allocateTargets() {
      ...
      if (
        ...
        let { _lodMax: r } = this;
        (({ sizeLods: this._sizeLods, lodPlanes: this._lodPlanes, sigmas: this._sigmas } = Ea(r)),
          (this._blurMaterial = ka(r, e, t)));
      }
      return r;
    }
    _compileMaterial(e) {
    ...
    _sceneToCubeUV(e, t, n, r, i) {
      ...
      let d = new Qn({ name: `PMREM.Background`, side: 1, depthWrite: !1, depthTest: !1 }),
        f = new Tr(new Or(), d),
        p = !1,
        m = e.background;
      m
    ...
    _textureToCubeUV(e, t) {
      ...
      r
        ...
        : this._equirectMaterial === null && (this._equirectMaterial = Aa());
      let i = r ? this._cubemapMaterial : this._equirectMaterial,
        a = new Tr(this._lodPlanes[0], i),
        o = i.uniforms;
      o.envMap.value = e;
      let s = this._cubeSize;
      (Oa(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, ha));
    }
    _applyPMREM(e) {
    ...
    _halfBlur(e, t, n, r, i, a, o) {
      ...
      let l = new Tr(this._lodPlanes[r], c),
        u = c.uniforms,
      ...
      (Oa(t, 3 * v * (r > _ - fa ? r - _ + fa : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v),
        s.setRenderTarget(t),
        s.render(l, ha));
    }
  };
function Ea(e) {
  ...
  for (let o = 0; o < a; o++) {
    ...
    n.push(a);
    let s = 1 / a;
    (o > e - fa ? (s = pa[o - e + fa - 1]) : o === 0 && (s = 0), r.push(s));
    let c = 1 / (a - 2),
      l = -c,
      u = 1 + c,
    ...
    let h = new pr();
    (h.setAttribute(`position`, new nr(f, 3)),
      h.setAttribute(`uv`, new nr(p, 2)),
      h.setAttribute(`faceIndex`, new nr(m, 1)),
      t.push(h),
      i > fa && i--);
  }
...
function Pa(e) {
  ...
  return {
    ...
    get: function (e) {
      let t = n(e);
      return (t === null && lt(`THREE.WebGLRenderer: ` + e + ` extension not supported.`), t);
    },
  };
}
function Fa(e, t, n, r) {
...
function Xa(e, t, n) {
  ...
  let i = t * n,
    a = Ga[i];
  if ((a === void 0 && ((a = new Float32Array(i)), (Ga[i] = a)), t !== 0)) {
    r.toArray(a, 0);
...
function io(e, t) {
  ...
  if (r === void 0) {
    ...
    if (Za(n, r)) return;
    (Ya.set(r), e.uniformMatrix2fv(this.addr, !1, Ya), Qa(n, r));
  }
}
function ao(e, t) {
  let n = this.cache,
  ...
  if (r === void 0) {
    ...
    if (Za(n, r)) return;
    (Ja.set(r), e.uniformMatrix3fv(this.addr, !1, Ja), Qa(n, r));
  }
}
function oo(e, t) {
  let n = this.cache,
  ...
  if (r === void 0) {
    ...
    if (Za(n, r)) return;
    (qa.set(r), e.uniformMatrix4fv(this.addr, !1, qa), Qa(n, r));
  }
}
function so(e, t) {
  let n = this.cache;
...
function go(e, t, n) {
  ...
  let a;
  (this.type === e.SAMPLER_2D_SHADOW ? ((Va.compareFunction = 515), (a = Va)) : (a = Ba),
    n.setTexture2D(t || a, i));
}
function _o(e, t, n) {
  let r = this.cache,
    i = n.allocateTextureUnit();
  (r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)), n.setTexture3D(t || Ua, i));
}
function vo(e, t, n) {
  let r = this.cache,
    i = n.allocateTextureUnit();
  (r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)), n.setTextureCube(t || Wa, i));
}
function yo(e, t, n) {
  let r = this.cache,
    i = n.allocateTextureUnit();
  (r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)), n.setTexture2DArray(t || Ha, i));
}
function bo(e) {
  switch (e) {
    case 5126:
...
function So(e, t) {
  let n = Xa(t, this.size, 2);
  e.uniform2fv(this.addr, n);
}
function Co(e, t) {
  let n = Xa(t, this.size, 3);
  e.uniform3fv(this.addr, n);
}
function wo(e, t) {
  let n = Xa(t, this.size, 4);
...
function Eo(e, t) {
  let n = Xa(t, this.size, 9);
  e.uniformMatrix3fv(this.addr, !1, n);
}
function Do(e, t) {
  let n = Xa(t, this.size, 16);
...
function Io(e, t, n) {
  let r = this.cache,
    i = t.length,
    a = $a(n, i);
  Za(r, a) || (e.uniform1iv(this.addr, a), Qa(r, a));
  for (let e = 0; e !== i; ++e) n.setTexture2D(t[e] || Ba, a[e]);
}
function Lo(e, t, n) {
  let r = this.cache,
    i = t.length,
    a = $a(n, i);
  Za(r, a) || (e.uniform1iv(this.addr, a), Qa(r, a));
  for (let e = 0; e !== i; ++e) n.setTexture3D(t[e] || Ua, a[e]);
}
function Ro(e, t, n) {
  let r = this.cache,
    i = t.length,
    a = $a(n, i);
  Za(r, a) || (e.uniform1iv(this.addr, a), Qa(r, a));
  for (let e = 0; e !== i; ++e) n.setTextureCube(t[e] || Wa, a[e]);
}
function zo(e, t, n) {
  let r = this.cache,
    i = t.length,
    a = $a(n, i);
  Za(r, a) || (e.uniform1iv(this.addr, a), Qa(r, a));
  for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || Ha, a[e]);
}
function Bo(e) {
  switch (e) {
    case 5126:
...
function Ko(e, t, n) {
  ...
  for (Wo.lastIndex = 0; ;) {
    ...
    if ((c && (s |= 0), l === void 0 || (l === `[` && o + 2 === i))) {
      Go(n, l === void 0 ? new Vo(s, e, t) : new Ho(s, e, t));
      break;
    } else {
      let e = n.map[s];
      (e === void 0 && ((e = new Uo(s)), Go(n, e)), (n = e));
    }
  }
}
var qo = class {
  constructor(e, t) {
    ...
    for (let r = 0; r < n; ++r) {
      ...
      Ko(n, e.getUniformLocation(t, n.name), this);
    }
  }
  setValue(e, t, n, r) {
    let i = this.map[t];
...
var Qo = new G();
function $o(e) {
  K._getMatrix(Qo, K.workingColorSpace, e);
...
` +
  ...
  let y = v + g + o,
    b = v + _ + s,
    x = Jo(i, i.VERTEX_SHADER, y),
    S = Jo(i, i.FRAGMENT_SHADER, b);
  (i.attachShader(h, x),
    i.attachShader(h, S),
...
` +
    ...
    (i.deleteShader(x), i.deleteShader(S), (w = new qo(i, h)), (T = ss(i, h)));
  }
  let w;
  ...
  return (
    (this.isReady = function () {
      return (E === !1 && (E = i.getProgramParameter(h, Yo)), E);
    }),
...
function Os(e, t, n, r, i, a, o) {
  ...
  function g(a, s, u, g, _) {
    ...
    let j = e.getRenderTarget(),
      ...
      me = a.sheen > 0,
      I = a.transmission > 0,
      he = ue && !!a.anisotropyMap,
      L = de && !!a.clearcoatMap,
      R = de && !!a.clearcoatNormalMap,
      z = de && !!a.clearcoatRoughnessMap,
      ge = pe && !!a.iridescenceMap,
      B = pe && !!a.iridescenceThicknessMap,
      V = me && !!a.sheenColorMap,
      _e = me && !!a.sheenRoughnessMap,
      ve = !!a.specularMap,
      ye = !!a.specularColorMap,
      be = !!a.specularIntensityMap,
      xe = I && !!a.transmissionMap,
      Se = I && !!a.thicknessMap,
      Ce = !!a.gradientMap,
      we = !!a.alphaMap,
      Te = a.alphaTest > 0,
    ...
    let ke = {
      ...
      precision: p,
      batching: M,
      batchingColor: M && _._colorsTexture !== null,
      instancing: te,
      instancingColor: te && _.instanceColor !== null,
      instancingMorph: te && _.morphTexture !== null,
      supportsVertexTextures: f,
      outputColorSpace:
        j === null ? e.outputColorSpace : j.isXRRenderTarget === !0 ? j.texture.colorSpace : Be,
      ...
      emissiveMap: F,
      normalMapObjectSpace: oe && a.normalMapType === 1,
      normalMapTangentSpace: oe && a.normalMapType === 0,
      metalnessMap: ce,
      roughnessMap: le,
      anisotropy: ue,
      anisotropyMap: he,
      ...
      normalMapUv: oe && h(a.normalMap.channel),
      displacementMapUv: se && h(a.displacementMap.channel),
      emissiveMapUv: F && h(a.emissiveMap.channel),
      ...
      clearcoatRoughnessMapUv: z && h(a.clearcoatRoughnessMap.channel),
      iridescenceMapUv: ge && h(a.iridescenceMap.channel),
      iridescenceThicknessMapUv: B && h(a.iridescenceThicknessMap.channel),
      sheenColorMapUv: V && h(a.sheenColorMap.channel),
      sheenRoughnessMapUv: _e && h(a.sheenRoughnessMap.channel),
      specularMapUv: ve && h(a.specularMap.channel),
      ...
      vertexTangents: !!y.attributes.tangent && (oe || ue),
      ...
      toneMapping: Oe,
      decodeVideoTexture:
        N && a.map.isVideoTexture === !0 && K.getTransfer(a.map.colorSpace) === `srgb`,
      decodeVideoTextureEmissive:
        F &&
        a.emissiveMap.isVideoTexture === !0 &&
        K.getTransfer(a.emissiveMap.colorSpace) === `srgb`,
      ...
      extensionClipCullDistance:
        De && a.extensions.clipCullDistance === !0 && r.has(`WEBGL_clip_cull_distance`),
      extensionMultiDraw: ((De && a.extensions.multiDraw === !0) || M) && r.has(`WEBGL_multi_draw`),
      rendererExtensionParallelShaderCompile: r.has(`KHR_parallel_shader_compile`),
      customProgramCacheKey: a.customProgramCacheKey(),
    };
    return (
      (ke.vertexUv1s = l.has(1)),
      (ke.vertexUv2s = l.has(2)),
      (ke.vertexUv3s = l.has(3)),
      l.clear(),
      ke
    );
  }
  ...
  function x(t, n) {
    ...
    return (r === void 0 && ((r = new ws(e, n, t, a)), u.push(r)), r);
  }
  function S(e) {
    if (--e.usedTimes === 0) {
      let t = u.indexOf(e);
    ...
    get: function (t) {
      ...
      switch (t.type) {
        ...
        case `SpotLight`:
          ...
          break;
        case `PointLight`:
          n = { position: new W(), color: new q(), distance: 0, decay: 0 };
          break;
        case `HemisphereLight`:
          n = { direction: new W(), skyColor: new q(), groundColor: new q() };
          break;
        case `RectAreaLight`:
          n = { color: new q(), position: new W(), halfWidth: new W(), halfHeight: new W() };
          break;
      }
      return ((e[t.id] = n), n);
    },
...
function Us(e, t, n) {
  ...
  let h = new pr();
  h.setAttribute(`position`, new nr(new Float32Array([-1, -1, 0.5, 3, -1, 0.5, -1, 3, 0.5]), 3));
  let g = new Tr(h, p),
    _ = this;
  ...
  this.render = function (t, n, s) {
    ...
    let c = e.getRenderTarget(),
      ...
      p = e.state;
    (p.setBlending(0),
      p.buffers.depth.getReversed() === !0
        ? p.buffers.color.setClear(0, 0, 0, 0)
    ...
    for (let c = 0, l = t.length; c < l; c++) {
      ...
      if (
        ...
        a.copy(d.mapSize),
        (i.x > u || i.y > u) &&
          (i.x > u && ((a.x = Math.floor(u / g.x)), (i.x = a.x * g.x), (d.mapSize.x = a.x)),
          i.y > u && ((a.y = Math.floor(u / g.y)), (i.y = a.y * g.y), (d.mapSize.y = a.y))),
        d.map === null || m === !0 || h === !0)
      ) {
        let e = this.type === 3 ? {} : { minFilter: f, magFilter: f };
        (d.map !== null && d.map.dispose(),
          (d.map = new Et(i.x, i.y, e)),
          (d.map.texture.name = l.name + `.shadowMap`),
          d.camera.updateProjectionMatrix());
      }
      (e.setRenderTarget(d.map), e.clear());
      let _ = d.getViewportCount();
      for (let e = 0; e < _; e++) {
        ...
        (o.set(a.x * t.x, a.y * t.y, a.x * t.z, a.y * t.w),
          ...
          (r = d.getFrustum()),
          x(n, s, d.camera, l, this.type));
      }
      (d.isPointLightShadow !== !0 && this.type === 3 && y(d, s), (d.needsUpdate = !1));
    }
...
function Gs(e, t) {
  ...
  let a = new n(),
    ...
    ee = !1,
    te = 0,
    M = e.getParameter(e.VERSION);
  M.indexOf(`WebGL`) === -1
    ? M.indexOf(`OpenGL ES`) !== -1 &&
      ((te = parseFloat(/^OpenGL ES (\d)/.exec(M)[1])), (ee = te >= 2))
    : ((te = parseFloat(/^WebGL (\d)/.exec(M)[1])), (ee = te >= 1));
  let N = null,
    P = {},
    ne = e.getParameter(e.SCISSOR_BOX),
    re = e.getParameter(e.VIEWPORT),
    ie = new wt().fromArray(ne),
    ae = new wt().fromArray(re);
  function oe(t, n, r, i) {
  ...
  let fe = { 100: e.FUNC_ADD, 101: e.FUNC_SUBTRACT, 102: e.FUNC_REVERSE_SUBTRACT };
  ...
  function me(t, n, r, i, a, o, s, c, l, u) {
    ...
    if ((h === !1 && (F(e.BLEND), (h = !0)), t !== 5)) {
      if (t !== g || u !== T) {
        if (((_ !== 100 || b !== 100) && (e.blendEquation(e.FUNC_ADD), (_ = 100), (b = 100)), u))
          switch (t) {
            case 1:
    ...
    ((a ||= n),
      (o ||= r),
      (s ||= i),
      (n !== _ || a !== b) && (e.blendEquationSeparate(fe[n], fe[a]), (_ = n), (b = a)),
      (r !== v || i !== y || o !== x || s !== S) &&
        (e.blendFuncSeparate(pe[r], pe[i], pe[o], pe[s]), (v = r), (y = i), (x = o), (S = s)),
      (c.equals(C) === !1 || l !== w) && (e.blendColor(c.r, c.g, c.b, l), C.copy(c), (w = l)),
      (g = t),
      (T = !1));
  }
  function I(t, n) {
  ...
  function R(t) {
    t !== O && (ee && e.lineWidth(t), (O = t));
  }
  function z(t, n, r) {
    t
      ? (F(e.POLYGON_OFFSET_FILL),
        (k !== n || A !== r) && (e.polygonOffset(n, r), (k = n), (A = r)))
  ...
  function V(t, n, r) {
    ...
    let i = P[r];
    (i === void 0 && ((i = { type: void 0, texture: void 0 }), (P[r] = i)),
...
function Ks(e, t, n, r, i, a, o) {
  ...
  function C(e, t) {
    return S ? new OffscreenCanvas(e, t) : ot(`canvas`);
  }
  function w(e, t, n) {
    let r = 1,
      i = Ee(e);
  ...
  function O(n, r, i, a, o = !1) {
    ...
    if (
      ...
      let t = o ? Ve : K.getTransfer(a);
      (i === e.FLOAT && (s = e.RGBA32F),
        i === e.HALF_FLOAT && (s = e.RGBA16F),
        i === e.UNSIGNED_BYTE && (s = t === `srgb` ? e.SRGB8_ALPHA8 : e.RGBA8),
  ...
  function A(e, t) {
    return T(e) === !0 || (e.isFramebufferTexture && e.minFilter !== 1003 && e.minFilter !== 1006)
  ...
  function j(e) {
    let t = e.target;
    (t.removeEventListener(`dispose`, j), te(t), t.isVideoTexture && y.delete(t));
  }
  function ee(e) {
    let t = e.target;
    (t.removeEventListener(`dispose`, ee), P(t));
  }
  function te(e) {
    let t = r.get(e);
    ...
    if (i) {
      ...
      (r.usedTimes--, r.usedTimes === 0 && M(e), Object.keys(i).length === 0 && x.delete(n));
    }
    r.remove(e);
  }
  function M(t) {
  ...
  let le = { [l]: e.REPEAT, [u]: e.CLAMP_TO_EDGE, [d]: e.MIRRORED_REPEAT },
    ue = {
      [f]: e.NEAREST,
  ...
  function fe(n, a) {
    if (
      ...
      e.texParameteri(n, e.TEXTURE_WRAP_S, le[a.wrapS]),
      e.texParameteri(n, e.TEXTURE_WRAP_T, le[a.wrapT]),
      (n === e.TEXTURE_3D || n === e.TEXTURE_2D_ARRAY) &&
        e.texParameteri(n, e.TEXTURE_WRAP_R, le[a.wrapR]),
      e.texParameteri(n, e.TEXTURE_MAG_FILTER, ue[a.magFilter]),
      e.texParameteri(n, e.TEXTURE_MIN_FILTER, ue[a.minFilter]),
      a.compareFunction &&
        (e.texParameteri(n, e.TEXTURE_COMPARE_MODE, e.COMPARE_REF_TO_TEXTURE),
        e.texParameteri(n, e.TEXTURE_COMPARE_FUNC, de[a.compareFunction])),
  ...
  function pe(t, n) {
    ...
    if (s !== t.__cacheKey) {
      (a[s] === void 0 &&
        ((a[s] = { texture: e.createTexture(), usedTimes: 0 }), o.memory.textures++, (r = !0)),
        a[s].usedTimes++);
      let i = a[t.__cacheKey];
      (i !== void 0 && (a[t.__cacheKey].usedTimes--, i.usedTimes === 0 && M(n)),
        (t.__cacheKey = s),
    ...
    if (o.length === 0) n.texSubImage2D(e.TEXTURE_2D, 0, 0, 0, r.width, r.height, i, a, r.data);
      ...
      for (let e = 1; e < o.length; e++) {
        let t = o[s],
          n = o[e],
          i = t.start + t.count,
          a = me(n.start, r.width, 4),
          c = me(t.start, r.width, 4);
        n.start <= i + 1 && a === c && me(n.start + n.count - 1, r.width, 4) === a
          ? (t.count = Math.max(t.count, n.start + n.count - t.start))
          : (++s, (o[s] = n));
      }
      o.length = s + 1;
      let c = e.getParameter(e.UNPACK_ROW_LENGTH),
        l = e.getParameter(e.UNPACK_SKIP_PIXELS),
      ...
      (t.clearUpdateRanges(),
        e.pixelStorei(e.UNPACK_ROW_LENGTH, c),
        e.pixelStorei(e.UNPACK_SKIP_PIXELS, l),
  ...
  function he(t, o, s) {
    ...
    if (u.version !== d.__version || l === !0) {
      ...
      let t = K.getPrimaries(K.workingColorSpace),
        r = o.colorSpace === `` ? null : K.getPrimaries(o.colorSpace),
        f = o.colorSpace === `` || t === r ? e.NONE : e.BROWSER_DEFAULT_WEBGL;
      ...
      let p = w(o.image, !1, i.maxTextureSize);
      p = Te(o, p);
      let m = a.convert(o.format, o.colorSpace),
        h = a.convert(o.type),
        g = O(o.internalFormat, m, h, o.colorSpace, o.isVideoTexture);
      fe(c, o);
      let _,
        v = o.mipmaps,
        y = o.isVideoTexture !== !0,
        b = d.__version === void 0 || l === !0,
        x = u.dataReady,
        S = A(o, p);
      if (o.isDepthTexture)
        ((g = k(o.format === N, o.type)),
          b &&
            (y
              ? n.texStorage2D(e.TEXTURE_2D, 1, g, p.width, p.height)
              : n.texImage2D(e.TEXTURE_2D, 0, g, p.width, p.height, 0, m, h, null)));
        ...
        if (v.length > 0) {
          ...
          for (let t = 0, r = v.length; t < r; t++)
            ((_ = v[t]),
              y
                ? x && n.texSubImage2D(e.TEXTURE_2D, t, 0, 0, _.width, _.height, m, h, _.data)
                : n.texImage2D(e.TEXTURE_2D, t, g, _.width, _.height, 0, m, h, _.data));
          o.generateMipmaps = !1;
        } else
          y
            ? (b && n.texStorage2D(e.TEXTURE_2D, S, g, p.width, p.height), x && I(o, p, m, h))
            : n.texImage2D(e.TEXTURE_2D, 0, g, p.width, p.height, 0, m, h, p.data);
      else if (o.isCompressedTexture)
        if (o.isCompressedArrayTexture) {
          y && b && n.texStorage3D(e.TEXTURE_2D_ARRAY, S, g, v[0].width, v[0].height, p.depth);
          for (let t = 0, r = v.length; t < r; t++)
            if (((_ = v[t]), o.format !== 1023))
              if (m !== null)
                if (y) {
                  if (x)
                    if (o.layerUpdates.size > 0) {
                      let r = Qi(_.width, _.height, o.format, o.type);
                      for (let i of o.layerUpdates) {
                        let a = _.data.subarray(
                          (i * r) / _.data.BYTES_PER_ELEMENT,
            ...
            ((_ = v[t]),
              o.format === 1023
                ...
                : m === null
                  ...
                  : y
                    ? x &&
                      n.compressedTexSubImage2D(e.TEXTURE_2D, t, 0, 0, _.width, _.height, m, _.data)
                    : n.compressedTexImage2D(e.TEXTURE_2D, t, g, _.width, _.height, 0, _.data));
        }
      else if (o.isDataArrayTexture)
        if (y) {
          if ((b && n.texStorage3D(e.TEXTURE_2D_ARRAY, S, g, p.width, p.height, p.depth), x))
            if (o.layerUpdates.size > 0) {
              let t = Qi(p.width, p.height, o.format, o.type);
              for (let r of o.layerUpdates) {
                let i = p.data.subarray(
                  (r * t) / p.data.BYTES_PER_ELEMENT,
                  ((r + 1) * t) / p.data.BYTES_PER_ELEMENT
                );
                n.texSubImage3D(e.TEXTURE_2D_ARRAY, 0, 0, 0, r, p.width, p.height, 1, m, h, i);
              }
              o.clearLayerUpdates();
            } else
              n.texSubImage3D(
        ...
        } else n.texImage3D(e.TEXTURE_2D_ARRAY, 0, g, p.width, p.height, p.depth, 0, m, h, p.data);
      else if (o.isData3DTexture)
        y
          ? (b && n.texStorage3D(e.TEXTURE_3D, S, g, p.width, p.height, p.depth),
            x &&
              n.texSubImage3D(e.TEXTURE_3D, 0, 0, 0, 0, p.width, p.height, p.depth, m, h, p.data))
          : n.texImage3D(e.TEXTURE_3D, 0, g, p.width, p.height, p.depth, 0, m, h, p.data);
      else if (o.isFramebufferTexture) {
        if (b)
          if (y) n.texStorage2D(e.TEXTURE_2D, S, g, p.width, p.height);
          else {
            let t = p.width,
              r = p.height;
            for (let i = 0; i < S; i++)
              (n.texImage2D(e.TEXTURE_2D, i, g, t, r, 0, m, h, null), (t >>= 1), (r >>= 1));
          }
      } else if (v.length > 0) {
        if (y && b) {
          let t = Ee(v[0]);
        ...
        for (let t = 0, r = v.length; t < r; t++)
          ((_ = v[t]),
            y
              ? x && n.texSubImage2D(e.TEXTURE_2D, t, 0, 0, m, h, _)
              : n.texImage2D(e.TEXTURE_2D, t, g, m, h, _));
        o.generateMipmaps = !1;
      } else if (y) {
        if (b) {
          let t = Ee(p);
        ...
        x && n.texSubImage2D(e.TEXTURE_2D, 0, 0, 0, m, h, p);
      } else n.texImage2D(e.TEXTURE_2D, 0, g, m, h, p);
      (T(o) && E(c), (d.__version = u.version), o.onUpdate && o.onUpdate(o));
    }
  ...
  function L(t, o, s) {
    ...
    if (l.version !== u.__version || c === !0) {
      ...
      for (let e = 0; e < 6; e++)
        (!f && !p
          ? (m[e] = w(o.image[e], !0, i.maxCubemapSize))
          : (m[e] = p ? o.image[e].image : o.image[e]),
          (m[e] = Te(o, m[e])));
      let h = m[0],
        g = a.convert(o.format, o.colorSpace),
        _ = a.convert(o.type),
        v = O(o.internalFormat, g, _, o.colorSpace),
        y = o.isVideoTexture !== !0,
        b = u.__version === void 0 || c === !0,
        x = l.dataReady,
        S = A(o, h);
      ...
      if (f) {
        ...
        for (let t = 0; t < 6; t++)
          if (p) {
            ...
            y
              ? x && n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + t, 0, 0, 0, g, _, m[t])
              : n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + t, 0, v, g, _, m[t]);
            for (let r = 0; r < C.length; r++) {
              let i = C[r];
              y
                ? x &&
                  n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + t, r + 1, 0, 0, g, _, i.image[t])
                : n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + t, r + 1, v, g, _, i.image[t]);
            }
          }
      }
      (T(o) && E(e.TEXTURE_CUBE_MAP), (u.__version = l.version), o.onUpdate && o.onUpdate(o));
    }
    t.__version = o.version;
  }
  function R(t, i, o, c, l, u) {
    let d = a.convert(o.format, o.colorSpace),
      f = a.convert(o.type),
      p = O(o.internalFormat, d, f, o.colorSpace),
      m = r.get(i),
      h = r.get(o);
    ...
    (n.bindFramebuffer(e.FRAMEBUFFER, t),
      Ce(i)
        ? s.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, c, l, h.__webglTexture, 0, Se(i))
        : (l === e.TEXTURE_2D ||
  ...
  function z(t, n, r) {
    if ((e.bindRenderbuffer(e.RENDERBUFFER, t), n.depthBuffer)) {
      let i = n.depthTexture,
        ...
        o = k(n.stencilBuffer, a),
        c = n.stencilBuffer ? e.DEPTH_STENCIL_ATTACHMENT : e.DEPTH_ATTACHMENT,
        l = Se(n);
      (Ce(n)
        ? s.renderbufferStorageMultisampleEXT(e.RENDERBUFFER, l, o, n.width, n.height)
        : r
          ? e.renderbufferStorageMultisample(e.RENDERBUFFER, l, o, n.width, n.height)
      ...
      for (let i = 0; i < t.length; i++) {
        let o = t[i],
          ...
          l = a.convert(o.type),
          u = O(o.internalFormat, c, l, o.colorSpace),
          d = Se(n);
        r && Ce(n) === !1
          ? e.renderbufferStorageMultisample(e.RENDERBUFFER, d, u, n.width, n.height)
          : Ce(n)
            ? s.renderbufferStorageMultisampleEXT(e.RENDERBUFFER, d, u, n.width, n.height)
  ...
  function B(t) {
    ...
    if (t.depthTexture && !i.__autoAllocateDepthBuffer) {
      ...
      e && e.length > 0 ? ge(i.__webglFramebuffer[0], t) : ge(i.__webglFramebuffer, t);
    } else if (a) {
      ...
      for (let r = 0; r < 6; r++)
        if (
          ...
          ((i.__webglDepthbuffer[r] = e.createRenderbuffer()), z(i.__webglDepthbuffer[r], t, !1));
        else {
      ...
      if (
        ...
        ((i.__webglDepthbuffer = e.createRenderbuffer()), z(i.__webglDepthbuffer, t, !1));
      else {
        let n = t.stencilBuffer ? e.DEPTH_STENCIL_ATTACHMENT : e.DEPTH_ATTACHMENT,
  ...
  function V(t, n, i) {
    let a = r.get(t);
    (n !== void 0 && R(a.__webglFramebuffer, t, t.texture, e.COLOR_ATTACHMENT0, e.TEXTURE_2D, 0),
      i !== void 0 && B(t));
  }
  function _e(t) {
    let i = t.texture,
      ...
      if (t.samples > 0 && Ce(t) === !1) {
        ...
        for (let n = 0; n < l.length; n++) {
          ...
          let i = a.convert(r.format, r.colorSpace),
            o = a.convert(r.type),
            c = O(r.internalFormat, i, o, r.colorSpace, t.isXRRenderTarget === !0),
            u = Se(t);
        ...
        (e.bindRenderbuffer(e.RENDERBUFFER, null),
          t.depthBuffer &&
            ...
            z(s.__webglDepthRenderbuffer, t, !0)),
          n.bindFramebuffer(e.FRAMEBUFFER, null));
      }
    }
    if (u) {
      ...
      (T(i) && E(e.TEXTURE_CUBE_MAP), n.unbindTexture());
    } else if (d) {
      for (let i = 0, a = l.length; i < a; i++) {
        ...
        ((t.isWebGL3DRenderTarget || t.isWebGLArrayRenderTarget) &&
          ...
          fe(c, a),
          R(s.__webglFramebuffer, t, a, e.COLOR_ATTACHMENT0 + i, c, 0),
          T(a) && E(c));
      }
      n.unbindTexture();
    } else {
      ...
      if (
        ...
        for (let n = 0; n < i.mipmaps.length; n++)
          R(s.__webglFramebuffer[n], t, i, e.COLOR_ATTACHMENT0, r, n);
      else R(s.__webglFramebuffer, t, i, e.COLOR_ATTACHMENT0, r, 0);
      (T(i) && E(r), n.unbindTexture());
    }
    t.depthBuffer && B(t);
  }
  function ve(e) {
        ...
        for (let n = 0; n < i.length; n++) {
          ...
          (e.blitFramebuffer(0, 0, a, o, 0, 0, a, o, s, e.NEAREST),
            c === !0 &&
              ((ye.length = 0),
              (be.length = 0),
              ye.push(e.COLOR_ATTACHMENT0 + n),
              t.depthBuffer &&
                t.resolveDepthBuffer === !1 &&
                (ye.push(l), be.push(l), e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER, be)),
  ...
  Xs = class {
    ...
    getMesh(e) {
      if (this.texture !== null && this.mesh === null) {
        ...
        this.mesh = new Tr(new hi(20, 20), n);
      }
      return this.mesh;
    }
    reset() {
    ...
    constructor(e, t) {
      ...
      ((this.cameraAutoUpdate = !0),
        ...
        (this.getController = function (e) {
          let t = x[e];
          return (t === void 0 && ((t = new Yr()), (x[e] = t)), t.getTargetRaySpace());
        }),
        (this.getControllerGrip = function (e) {
          let t = x[e];
          return (t === void 0 && ((t = new Yr()), (x[e] = t)), t.getGripSpace());
        }),
        (this.getHand = function (e) {
          let t = x[e];
          return (t === void 0 && ((t = new Yr()), (x[e] = t)), t.getHandSpace());
        }));
      function P(e) {
          ...
          if (((r = l), r !== null)) {
            if (
              ...
              ((u = this.getBinding()),
                ...
                (b = new Et(d.textureWidth, d.textureHeight, {
                  format: te,
                  type: v,
                  depthTexture: new pi(
                    d.textureWidth,
              ...
              ((f = new XRWebGLLayer(r, t, n)),
                ...
                (b = new Et(f.framebufferWidth, f.framebufferHeight, {
                  format: te,
                  type: v,
                  colorSpace: e.outputColorSpace,
                  stencilBuffer: _.stencil,
      ...
      this.updateCamera = function (e) {
        ...
        (h.texture !== null &&
          ...
          (E.layers.mask = A.layers.mask & 3),
          (D.layers.mask = A.layers.mask & 5));
        let i = e.parent,
          a = A.cameras;
        se(A, i);
        for (let e = 0; e < a.length; e++) se(a[e], i);
        (a.length === 2 ? oe(A, E, D) : A.projectionMatrix.copy(E.projectionMatrix), F(e, A, i));
      };
      function F(e, t, n) {
        (n === null
          ...
          e.isPerspectiveCamera &&
            ((e.fov = Ye * 2 * Math.atan(1 / e.projectionMatrix.elements[5])), (e.zoom = 1)));
      }
        ...
        if (((l = i.getViewerPose(c || a)), (p = i), l !== null)) {
          ...
          for (let n = 0; n < t.length; n++) {
            ...
            if (f !== null) a = f.getViewport(r);
              ...
              ((a = t.viewport),
                n === 0 &&
                  (e.setRenderTargetTextures(b, t.colorTexture, t.depthStencilTexture),
                  e.setRenderTarget(b)));
            }
            let o = k[n];
            (o === void 0 &&
              ((o = new Vr()), o.layers.enable(n), (o.viewport = new wt()), (k[n] = o)),
              o.matrix.fromArray(r.transform.matrix),
              ...
              n === 0 &&
                (A.matrix.copy(o.matrix), A.matrix.decompose(A.position, A.quaternion, A.scale)),
...
function ec(e, t) {
  ...
  function r(t, n) {
    (n.color.getRGB(t.fogColor.value, Mr(e)),
      n.isFog
  ...
  function a(e, r) {
    ...
    (a &&
      ...
      (Qs.y *= -1),
      (Qs.z *= -1),
      a.isCubeTexture && a.isRenderTargetTexture === !1 && ((Qs.y *= -1), (Qs.z *= -1)),
      e.envMapRotation.value.setFromMatrix4($s.makeRotationFromEuler(Qs)),
...
var nc = class {
  constructor(e = {}) {
    ...
    try {
      ...
      if (
        (`setAttribute` in t && t.setAttribute(`data-engine`, `three.js r180`),
    ...
    let L, R, z, ge, B, V, _e, ve, ye, be, xe, Se, Ce, we, Te, Ee, De, Oe, ke, Ae, je, Me, Ne, Pe;
    function Fe() {
      ((L = new Pa(I)),
        L.init(),
        (Me = new qs(I, L)),
        (R = new la(I, L, e, Me)),
        (z = new Gs(I, L)),
        R.reversedDepthBuffer && d && z.buffers.depth.setReversed(!0),
        (ge = new La(I)),
        (B = new ks()),
        (V = new Ks(I, L, z, B, R, Me, ge)),
        (_e = new da(x)),
        (ve = new Na(x)),
        (ye = new ta(I)),
        (Ne = new sa(I, ye)),
        (be = new Fa(I, ye, ge, Ne)),
        (xe = new za(I, be, ye, ge)),
        (ke = new Ra(I, R, V)),
        (Ee = new ua(B)),
        (Se = new Os(x, _e, ve, L, R, Ne, Ee)),
        (Ce = new ec(x, B)),
        (we = new Ns()),
        (Te = new Bs(L)),
        (Oe = new oa(x, _e, ve, z, xe, f, s)),
        (De = new Us(x, xe, R)),
        (Pe = new tc(I, ge, R, z)),
        (Ae = new ca(I, L, ge)),
        (je = new Ia(I, L, ge)),
    ...
    ((this.xr = Ie),
      ...
      (this.setViewport = function (e, t, n, r) {
        (e.isVector4 ? ie.set(e.x, e.y, e.z, e.w) : ie.set(e, t, n, r),
          z.viewport(k.copy(ie).multiplyScalar(P).round()));
      }),
      (this.getScissor = function (e) {
        return e.copy(ae);
      }),
      (this.setScissor = function (e, t, n, r) {
        (e.isVector4 ? ae.set(e.x, e.y, e.z, e.w) : ae.set(e, t, n, r),
          z.scissor(A.copy(ae).multiplyScalar(P).round()));
      }),
      (this.getScissorTest = function () {
        return oe;
      }),
      (this.setScissorTest = function (e) {
        z.setScissorTest((oe = e));
      }),
      ...
      (this.clear = function (e = !0, t = !0, n = !0) {
        ...
        if (e) {
          ...
          if (e) {
            let e = E.texture.type,
              t = e === 1009 || e === 1014 || e === 1012 || e === 1020 || e === 1017 || e === 1018,
              n = Oe.getClearColor(),
              r = Oe.getClearAlpha(),
              i = n.r,
              a = n.g,
              o = n.b;
            t
              ? ((p[0] = i), (p[1] = a), (p[2] = o), (p[3] = r), I.clearBufferuiv(I.COLOR, 0, p))
              : ((m[0] = i), (m[1] = a), (m[2] = o), (m[3] = r), I.clearBufferiv(I.COLOR, 0, m));
          } else r |= I.COLOR_BUFFER_BIT;
        }
        (t && (r |= I.DEPTH_BUFFER_BIT),
          n && ((r |= I.STENCIL_BUFFER_BIT), this.state.buffers.stencil.setMask(4294967295)),
          I.clear(r));
      }),
      ...
      (this.dispose = function () {
        (t.removeEventListener(`webglcontextlost`, Le, !1),
          ...
          Se.dispose(),
          Ie.dispose(),
          Ie.removeEventListener(`sessionstart`, Ye),
          Ie.removeEventListener(`sessionend`, Xe),
          H.stop());
      }));
    function Le(e) {
    ...
    this.renderBufferDirect = function (e, t, n, r, i, a) {
      ...
      let h,
        g = Ae;
      if ((c !== null && ((h = ye.get(c)), (g = je), g.setIndex(h)), i.isMesh))
        r.wireframe === !0
          ? (z.setLineWidth(r.wireframeLinewidth * me()), g.setMode(I.LINES))
          : g.setMode(I.TRIANGLES);
      else if (i.isLine) {
        let e = r.linewidth;
        (e === void 0 && (e = 1),
          z.setLineWidth(e * me()),
          i.isLineSegments
            ? g.setMode(I.LINES)
            : i.isLineLoop
              ? g.setMode(I.LINE_LOOP)
              : g.setMode(I.LINE_STRIP));
    ...
    let H = new ea();
    (H.setAnimationLoop(Je),
      typeof self < `u` && H.setContext(self),
      (this.setAnimationLoop = function (e) {
        ((qe = e), Ie.setAnimationLoop(e), e === null ? H.stop() : H.start());
      }),
      Ie.addEventListener(`sessionstart`, Ye),
      Ie.addEventListener(`sessionend`, Xe),
      (this.render = function (e, t) {
        ...
        if (
          ...
          Ie.enabled === !0 &&
            Ie.isPresenting === !0 &&
            (Ie.cameraAutoUpdate === !0 && Ie.updateCamera(t), (t = Ie.getCamera())),
          e.isScene === !0 && e.onBeforeRender(x, e, t, E),
          (g = Te.get(e, b.length)),
          g.init(t),
          b.push(g),
          le.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
          se.setFromProjectionMatrix(le, Ge, t.reversedDepth),
          (ce = this.localClippingEnabled),
          (F = Ee.init(this.clippingPlanes, ce)),
          (h = we.get(e, y.length)),
          h.init(),
          y.push(h),
          ...
          e !== null && Ze(e, t, -1 / 0, x.sortObjects);
        }
        (Ze(e, t, 0, x.sortObjects),
          h.finish(),
          x.sortObjects === !0 && h.sort(ne, re),
          (pe = Ie.enabled === !1 || Ie.isPresenting === !1 || Ie.hasDepthSensing() === !1),
          pe && Oe.addToRenderList(h, e),
        ...
        (E !== null &&
          w === 0 &&
          (V.updateMultisampleRenderTarget(E), V.updateRenderTargetMipmap(E)),
          ...
          b.length > 0
            ? ((g = b[b.length - 1]),
              F === !0 && Ee.setGlobalState(x.clippingPlanes, g.state.camera))
            : (g = null),
          y.pop(),
          (h = y.length > 0 ? y[y.length - 1] : null));
      }));
    function Ze(e, t, n, r) {
          ...
          if (
            (r &&
              (e.boundingSphere === void 0
                ? (t.boundingSphere === null && t.computeBoundingSphere(),
                  de.copy(t.boundingSphere.center))
                : (e.boundingSphere === null && e.computeBoundingSphere(),
                  de.copy(e.boundingSphere.center)),
              de.applyMatrix4(e.matrixWorld).applyMatrix4(le)),
            Array.isArray(i))
          ) {
            let r = t.groups;
    ...
    function Qe(e, t, n, r) {
      let i = e.opaque,
        ...
        o = e.transparent;
      (g.setupLightsView(n),
        F === !0 && Ee.setGlobalState(x.clippingPlanes, n),
        r && z.viewport(k.copy(r)),
        i.length > 0 && et(i, t, n),
        a.length > 0 && et(a, t, n),
        o.length > 0 && et(o, t, n),
    ...
    function $e(e, t, n, r) {
      ...
      g.state.transmissionRenderTarget[r.id] === void 0 &&
        (g.state.transmissionRenderTarget[r.id] = new Et(1, 1, {
          generateMipmaps: !0,
          type: L.has(`EXT_color_buffer_half_float`) || L.has(`EXT_color_buffer_float`) ? T : v,
          minFilter: _,
          samples: 4,
          stencilBuffer: i,
      ...
      let a = g.state.transmissionRenderTarget[r.id],
        o = r.viewport || k;
      a.setSize(o.z * x.transmissionResolutionScale, o.w * x.transmissionResolutionScale);
      let s = x.getRenderTarget(),
        c = x.getActiveCubeFace(),
        l = x.getActiveMipmapLevel();
      (x.setRenderTarget(a),
        x.getClearColor(ee),
        (te = x.getClearAlpha()),
        te < 1 && x.setClearColor(16777215, 0.5),
        x.clear(),
        pe && Oe.render(n));
      let u = x.toneMapping;
      x.toneMapping = 0;
      ...
      if (
        ...
        g.setupLightsView(r),
        F === !0 && Ee.setGlobalState(x.clippingPlanes, r),
        et(e, n, r),
        V.updateMultisampleRenderTarget(a),
        V.updateRenderTargetMipmap(a),
        L.has(`WEBGL_multisampled_render_to_texture`) === !1)
      ) {
        let e = !1;
        for (let i = 0, a = t.length; i < a; i++) {
          let a = t[i],
      ...
      (x.setRenderTarget(s, c, l),
        x.setClearColor(ee, te),
    ...
    function et(e, t, n) {
      ...
      for (let i = 0, a = e.length; i < a; i++) {
        ...
        (l.allowOverride === !0 && r !== null && (l = r),
          o.layers.test(n.layers) && U(o, t, n, s, l, c));
      }
    }
    ...
    function tt(e, t, n) {
      ...
      ((r.environment = e.isMeshStandardMaterial ? t.environment : null),
        (r.fog = t.fog),
        (r.envMap = (e.isMeshStandardMaterial ? ve : _e).get(e.envMap || r.environment)),
        (r.envMapRotation =
          r.environment !== null && e.envMap === null ? t.environmentRotation : e.envMapRotation),
        l === void 0 && (e.addEventListener(`dispose`, He), (l = new Map()), (r.programs = l)));
      let u = l.get(c);
      if (u !== void 0) {
        if (r.currentProgram === u && r.lightsStateVersion === o) return (rt(e, s), u);
      } else
    ...
    function nt(e) {
      if (e.uniformsList === null) {
        ...
        e.uniformsList = qo.seqWithValue(t.seq, e.uniforms);
      }
    ...
    function G(e, t, n, r, i) {
      (t.isScene !== !0 && (t = fe), V.resetTextureUnits());
      let a = t.fog,
        o = r.isMeshStandardMaterial ? t.environment : null,
        s = E === null ? x.outputColorSpace : E.isXRRenderTarget === !0 ? E.texture.colorSpace : Be,
              ...
              : v.envMap === c
                ? (r.fog === !0 && v.fog !== a) ||
                  (v.numClippingPlanes !== void 0 &&
                    (v.numClippingPlanes !== Ee.numPlanes ||
                      v.numIntersection !== Ee.numIntersection))
                  ? (b = !0)
                  : v.vertexAlphas === l &&
                      v.vertexTangents === u &&
                      v.morphTargets === d &&
      ...
      let C = !1,
        ...
        A = v.uniforms;
      if (
        (z.useProgram(S.program) && ((C = !0), (w = !0), (T = !0)),
        r.id !== D && ((D = r.id), (w = !0)),
        C || O !== e)
      ) {
        (z.buffers.depth.getReversed() &&
          ...
          k.setValue(I, `projectionMatrix`, e.projectionMatrix),
          k.setValue(I, `viewMatrix`, e.matrixWorldInverse));
        let t = k.map.cameraPosition;
        (t !== void 0 && t.setValue(I, ue.setFromMatrixPosition(e.matrixWorld)),
          R.logarithmicDepthBuffer &&
            k.setValue(I, `logDepthBufFC`, 2 / (Math.log(e.far + 1) / Math.LN2)),
          (r.isMeshPhongMaterial ||
            ...
            r.isShaderMaterial) &&
            k.setValue(I, `isOrthographic`, e.isOrthographicCamera === !0),
          O !== e && ((O = e), (w = !0), (T = !0)));
      }
      if (i.isSkinnedMesh) {
        ...
        e &&
          ...
          k.setValue(I, `boneTexture`, e.boneTexture, V));
      }
      i.isBatchedMesh &&
        (k.setOptional(I, i, `batchingTexture`),
        k.setValue(I, `batchingTexture`, i._matricesTexture, V),
        k.setOptional(I, i, `batchingIdTexture`),
        k.setValue(I, `batchingIdTexture`, i._indirectTexture, V),
        k.setOptional(I, i, `batchingColorTexture`),
        i._colorsTexture !== null && k.setValue(I, `batchingColorTexture`, i._colorsTexture, V));
      let j = n.morphAttributes;
      if (
        ((j.position !== void 0 || j.normal !== void 0 || j.color !== void 0) && ke.update(i, n, S),
        (w || v.receiveShadow !== i.receiveShadow) &&
          ((v.receiveShadow = i.receiveShadow), k.setValue(I, `receiveShadow`, i.receiveShadow)),
        r.isMeshGouraudMaterial &&
          r.envMap !== null &&
          ((A.envMap.value = c),
          (A.flipEnvMap.value = c.isCubeTexture && c.isRenderTargetTexture === !1 ? -1 : 1)),
        r.isMeshStandardMaterial &&
          r.envMap === null &&
          t.environment !== null &&
          (A.envMapIntensity.value = t.environmentIntensity),
        w &&
          (k.setValue(I, `toneMappingExposure`, x.toneMappingExposure),
          v.needsLights && it(A, T),
          a && r.fog === !0 && Ce.refreshFogUniforms(A, a),
          Ce.refreshMaterialUniforms(A, r, P, N, g.state.transmissionRenderTarget[e.id]),
          qo.upload(I, nt(v), A, V)),
        r.isShaderMaterial &&
          r.uniformsNeedUpdate === !0 &&
          (qo.upload(I, nt(v), A, V), (r.uniformsNeedUpdate = !1)),
        r.isSpriteMaterial && k.setValue(I, `center`, i.center),
        k.setValue(I, `modelViewMatrix`, i.modelViewMatrix),
        k.setValue(I, `normalMatrix`, i.normalMatrix),
        k.setValue(I, `modelMatrix`, i.matrixWorld),
    ...
    ((this.setRenderTarget = function (e, t = 0, n = 0) {
      ...
      if (e) {
        ...
        if (s.__useDefaultFramebuffer !== void 0)
          (z.bindFramebuffer(I.FRAMEBUFFER, null), (r = !1));
        else if (s.__webglFramebuffer === void 0) V.setupRenderTarget(e);
        ...
        (e.isWebGLCubeRenderTarget
          ...
          A.copy(e.scissor),
          (j = e.scissorTest));
      } else (k.copy(ie).multiplyScalar(P).floor(), A.copy(ae).multiplyScalar(P).floor(), (j = oe));
      if (
        (n !== 0 && (i = ot),
        z.bindFramebuffer(I.FRAMEBUFFER, i) && r && z.drawBuffers(e, i),
        z.viewport(k),
        z.scissor(A),
        z.setScissorTest(j),
        a)
      ...
      (this.readRenderTargetPixels = function (e, t, n, r, i, a, o, s = 0) {
        ...
        if ((e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c)) {
          z.bindFramebuffer(I.FRAMEBUFFER, c);
          try {
            let o = e.textures[s],
              c = o.format,
              l = o.type;
            if (!R.textureFormatReadable(c)) {
              console.error(
                `THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`
              );
              return;
            }
            if (!R.textureTypeReadable(l)) {
              console.error(
            ...
            t >= 0 &&
              ...
              I.readPixels(t, n, r, i, Me.convert(c), Me.convert(l), a));
          } finally {
            let e = E === null ? null : B.get(E).__webglFramebuffer;
            z.bindFramebuffer(I.FRAMEBUFFER, e);
          }
        }
      }),
      (this.readRenderTargetPixelsAsync = async function (e, t, n, r, i, a, o, s = 0) {
        ...
        if ((e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c))
          if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
            ...
            (I.bindBuffer(I.PIXEL_PACK_BUFFER, d),
              I.bufferData(I.PIXEL_PACK_BUFFER, a.byteLength, I.STREAM_READ),
              e.textures.length > 1 && I.readBuffer(I.COLOR_ATTACHMENT0 + s),
              I.readPixels(t, n, r, i, Me.convert(l), Me.convert(u), 0));
            let f = E === null ? null : B.get(E).__webglFramebuffer;
            z.bindFramebuffer(I.FRAMEBUFFER, f);
      ...
      (this.copyFramebufferToTexture = function (e, t = null, n = 0) {
        let r = 2 ** -n,
          ...
          s = t === null ? 0 : t.y;
        (V.setTexture2D(e, 0),
          I.copyTexSubImage2D(I.TEXTURE_2D, n, 0, 0, o, s, i, a),
          z.unbindTexture());
      }));
    let ct = I.createFramebuffer(),
      dt = I.createFramebuffer();
    ((this.copyTextureToTexture = function (e, t, n = null, r = null, i = 0, a = null) {
      ...
      let g = Me.convert(t.format),
        _ = Me.convert(t.type),
        v;
      (t.isData3DTexture
        ? (V.setTexture3D(t, 0), (v = I.TEXTURE_3D))
        : t.isDataArrayTexture || t.isCompressedArrayTexture
          ? (V.setTexture2DArray(t, 0), (v = I.TEXTURE_2D_ARRAY))
          : (V.setTexture2D(t, 0), (v = I.TEXTURE_2D)),
      ...
      let y = I.getParameter(I.UNPACK_ROW_LENGTH),
        b = I.getParameter(I.UNPACK_IMAGE_HEIGHT),
        x = I.getParameter(I.UNPACK_SKIP_PIXELS),
        S = I.getParameter(I.UNPACK_SKIP_ROWS),
        C = I.getParameter(I.UNPACK_SKIP_IMAGES);
      (I.pixelStorei(I.UNPACK_ROW_LENGTH, h.width),
        I.pixelStorei(I.UNPACK_IMAGE_HEIGHT, h.height),
        I.pixelStorei(I.UNPACK_SKIP_PIXELS, l),
        I.pixelStorei(I.UNPACK_SKIP_ROWS, u),
        I.pixelStorei(I.UNPACK_SKIP_IMAGES, d));
      ...
      if (e.isDepthTexture) {
        ...
        (z.bindFramebuffer(I.READ_FRAMEBUFFER, h.__webglFramebuffer),
          z.bindFramebuffer(I.DRAW_FRAMEBUFFER, g.__webglFramebuffer));
        for (let n = 0; n < c; n++)
          (w &&
            ...
            I.blitFramebuffer(l, u, o, s, f, p, o, s, I.DEPTH_BUFFER_BIT, I.NEAREST));
        ...
        let n = B.get(e),
          r = B.get(t);
        (z.bindFramebuffer(I.READ_FRAMEBUFFER, ct), z.bindFramebuffer(I.DRAW_FRAMEBUFFER, dt));
        for (let e = 0; e < c; e++)
          (w
            ? I.framebufferTextureLayer(
                I.READ_FRAMEBUFFER,
            ...
            i === 0
              ? T
                ? I.copyTexSubImage3D(v, a, f, p, m + e, l, u, o, s)
                : I.copyTexSubImage2D(v, a, f, p, l, u, o, s)
              : I.blitFramebuffer(l, u, o, s, f, p, o, s, I.COLOR_BUFFER_BIT, I.NEAREST));
        (z.bindFramebuffer(I.READ_FRAMEBUFFER, null), z.bindFramebuffer(I.DRAW_FRAMEBUFFER, null));
      } else
        T
          ? e.isDataTexture || e.isData3DTexture
            ? I.texSubImage3D(v, a, f, p, m, o, s, c, g, _, h.data)
            : t.isCompressedArrayTexture
              ? I.compressedTexSubImage3D(v, a, f, p, m, o, s, c, g, h.data)
              : I.texSubImage3D(v, a, f, p, m, o, s, c, g, _, h)
          : e.isDataTexture
            ? I.texSubImage2D(I.TEXTURE_2D, a, f, p, o, s, g, _, h.data)
            : e.isCompressedTexture
              ? I.compressedTexSubImage2D(I.TEXTURE_2D, a, f, p, h.width, h.height, g, h.data)
              : I.texSubImage2D(I.TEXTURE_2D, a, f, p, o, s, g, _, h);
      (I.pixelStorei(I.UNPACK_ROW_LENGTH, y),
        I.pixelStorei(I.UNPACK_IMAGE_HEIGHT, b),
        I.pixelStorei(I.UNPACK_SKIP_PIXELS, x),
        I.pixelStorei(I.UNPACK_SKIP_ROWS, S),
        I.pixelStorei(I.UNPACK_SKIP_IMAGES, C),
        a === 0 && t.generateMipmaps && I.generateMipmap(v),
        z.unbindTexture());
    }),
      ...
      (this.resetState = function () {
        ((C = 0), (w = 0), (E = null), z.reset(), Ne.reset());
      }),
      typeof __THREE_DEVTOOLS__ < `u` &&
        __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`, { detail: this })));
  }
  ...
  set outputColorSpace(e) {
    ...
    ((t.drawingBufferColorSpace = K._getDrawingBufferColorSpace(e)),
      (t.unpackColorSpace = K._getUnpackColorSpace()));
  }
};
function rc(e) {
...
var ac = Array.prototype.forEach,
  ...
  Z = {
    ...
    compose: function () {
      var e = oc.call(arguments);
      return function () {
        for (var t = oc.call(arguments), n = e.length - 1; n >= 0; n--) t = [e[n].apply(this, t)];
        return t[0];
      };
    },
    each: function (e, t, n) {
      if (e) {
        if (ac && e.forEach && e.forEach === ac) e.forEach(t, n);
    ...
    toArray: function (e) {
      return e.toArray ? e.toArray() : oc.call(e);
    },
  ...
  sc = [
    ...
    },
    {
      ...
      conversions: {
        RGBA_OBJ: {
          read: function (e) {
            return Z.isNumber(e.r) && Z.isNumber(e.g) && Z.isNumber(e.b) && Z.isNumber(e.a)
        ...
        HSVA_OBJ: {
          read: function (e) {
            return Z.isNumber(e.h) && Z.isNumber(e.s) && Z.isNumber(e.v) && Z.isNumber(e.a)
  ...
  uc = function () {
    ...
    return (
      Z.each(sc, function (t) {
        if (t.litmus(e))
          return (
            Z.each(t.conversions, function (t, n) {
              if (((cc = t.read(e)), lc === !1 && cc !== !1))
                return ((lc = cc), (cc.conversionName = n), (cc.conversion = t), Z.BREAK);
            }),
            Z.BREAK
          );
      }),
  ...
  yc = (function () {
    function e() {
      if ((mc(this, e), (this.__state = uc.apply(this, arguments)), this.__state === !1))
...
function bc(e, t, n) {
  Object.defineProperty(e, t, {
    get: function () {
      return (this.__state.space === `RGB` || yc.recalculateRGB(this, t, n), this.__state[t]);
    },
    set: function (e) {
...
function xc(e, t) {
  Object.defineProperty(e, t, {
    get: function () {
      return (this.__state.space === `HSV` || yc.recalculateHSV(this), this.__state[t]);
    },
    set: function (e) {
      (this.__state.space !== `HSV` && (yc.recalculateHSV(this), (this.__state.space = `HSV`)),
        (this.__state[t] = e));
    },
  });
}
((yc.recalculateRGB = function (e, t, n) {
  if (e.__state.space === `HEX`) e.__state[t] = fc.component_from_hex(e.__state.hex, n);
  else if (e.__state.space === `HSV`)
    Z.extend(e.__state, fc.hsv_to_rgb(e.__state.h, e.__state.s, e.__state.v));
  else throw Error(`Corrupted color state`);
}),
  (yc.recalculateHSV = function (e) {
    var t = fc.rgb_to_hsv(e.r, e.g, e.b);
    (Z.extend(e.__state, { s: t.s, v: t.v }),
      Z.isNaN(t.h) ? Z.isUndefined(e.__state.h) && (e.__state.h = 0) : (e.__state.h = t.h));
  }),
  (yc.COMPONENTS = [`r`, `g`, `b`, `h`, `s`, `v`, `hex`, `a`]),
  bc(yc.prototype, `r`, 2),
  bc(yc.prototype, `g`, 1),
  bc(yc.prototype, `b`, 0),
  xc(yc.prototype, `h`),
  xc(yc.prototype, `s`),
  xc(yc.prototype, `v`),
  Object.defineProperty(yc.prototype, 'a', {
    get: function () {
  ...
  Object.defineProperty(yc.prototype, 'hex', {
    get: function () {
      return (
        this.__state.space !== `HEX` &&
          ((this.__state.hex = fc.rgb_to_hex(this.r, this.g, this.b)),
          (this.__state.space = `HEX`)),
        this.__state.hex
      );
    },
...
var Tc = /(\d+(\.\d+)?)px/;
function Ec(e) {
  if (e === `0` || Z.isUndefined(e)) return 0;
  var t = e.match(Tc);
  return Z.isNull(t) ? 0 : parseFloat(t[1]);
}
var Q = {
    ...
    fakeEvent: function (e, t, n, r) {
      ...
      (Z.defaults(o, r), e.dispatchEvent(o));
    },
    ...
    getWidth: function (e) {
      ...
      return (
        Ec(t[`border-left-width`]) +
        Ec(t[`border-right-width`]) +
        Ec(t[`padding-left`]) +
        Ec(t[`padding-right`]) +
        Ec(t.width)
      );
    ...
    getHeight: function (e) {
      var t = getComputedStyle(e);
      return (
        Ec(t[`border-top-width`]) +
        Ec(t[`border-bottom-width`]) +
        Ec(t[`padding-top`]) +
        Ec(t[`padding-bottom`]) +
        Ec(t.height)
      );
  ...
  Dc = (function (e) {
    ...
    function t(e, n) {
      mc(this, t);
      var r = vc(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n)),
        i = r;
      ((r.__prev = r.getValue()),
      ...
      return (
        Q.bind(r.__checkbox, `change`, a, !1),
  ...
  Oc = (function (e) {
    ...
    function t(e, n, r) {
      mc(this, t);
      var i = vc(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n)),
        a = r,
        o = i;
      if (((i.__select = document.createElement(`select`)), Z.isArray(a))) {
        var s = {};
        (Z.each(a, function (e) {
          s[e] = e;
        }),
      ...
      return (
        ...
        i.updateDisplay(),
        Q.bind(i.__select, `change`, function () {
    ...
    return (
      hc(t, [
        ...
        },
        {
          key: `updateDisplay`,
          value: function () {
            return Q.isActive(this.__select)
              ? this
  ...
  kc = (function (e) {
    ...
    function t(e, n) {
      ...
      return (
        ...
        Q.bind(r.__input, `keyup`, a),
        Q.bind(r.__input, `change`, a),
        Q.bind(r.__input, `blur`, o),
        Q.bind(r.__input, `keydown`, function (e) {
      ...
      hc(t, [
        {
          ...
          value: function () {
            return (
              Q.isActive(this.__input) || (this.__input.value = this.getValue()),
              gc(
                t.prototype.__proto__ || Object.getPrototypeOf(t.prototype),
                `updateDisplay`,
                this
...
var jc = (function (e) {
  ...
  function t(e, n, r) {
    ...
    return (
      ...
      (i.__max = a.max),
      (i.__step = a.step),
      Z.isUndefined(i.__step)
        ? i.initialValue === 0
          ? (i.__impliedStep = 1)
          : (i.__impliedStep =
              10 ** Math.floor(Math.log(Math.abs(i.initialValue)) / Math.LN10) / 10)
        : (i.__impliedStep = i.__step),
      (i.__precision = Ac(i.__impliedStep)),
      i
    );
  }
  return (
    hc(t, [
      {
        ...
        value: function (e) {
          var n = e;
          return (
            this.__min !== void 0 && n < this.__min
              ? (n = this.__min)
              : this.__max !== void 0 && n > this.__max && (n = this.__max),
            this.__step !== void 0 &&
              n % this.__step !== 0 &&
              (n = Math.round(n / this.__step) * this.__step),
            gc(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), `setValue`, this).call(
              this,
              n
            )
          );
      ...
      },
      {
        key: `step`,
        value: function (e) {
          return ((this.__step = e), (this.__impliedStep = e), (this.__precision = Ac(e)), this);
        },
      },
    ]),
    t
...
var Nc = (function (e) {
  ...
  function t(e, n, r) {
    mc(this, t);
    var i = vc(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n, r));
    i.__truncationSuspended = !1;
    var a = i,
      o = void 0;
    function s() {
      var e = parseFloat(a.__input.value);
      Z.isNaN(e) || a.setValue(e);
    }
    function c() {
    ...
    function d() {
      (Q.unbind(window, `mousemove`, u), Q.unbind(window, `mouseup`, d), c());
    }
    function f(e) {
      (Q.bind(window, `mousemove`, u), Q.bind(window, `mouseup`, d), (o = e.clientY));
    }
    return (
      (i.__input = document.createElement(`input`)),
      i.__input.setAttribute(`type`, `text`),
      Q.bind(i.__input, `change`, s),
      Q.bind(i.__input, `blur`, l),
      Q.bind(i.__input, `mousedown`, f),
      Q.bind(i.__input, `keydown`, function (e) {
        e.keyCode === 13 &&
          ((a.__truncationSuspended = !0), this.blur(), (a.__truncationSuspended = !1), c());
      }),
      i.updateDisplay(),
        ...
        value: function () {
          return (
            (this.__input.value = this.__truncationSuspended
              ? this.getValue()
              : Mc(this.getValue(), this.__precision)),
            gc(
              t.prototype.__proto__ || Object.getPrototypeOf(t.prototype),
              `updateDisplay`,
              this
...
var Fc = (function (e) {
    ...
    function t(e, n, r, i, a) {
      ...
      var o = vc(
          this,
          (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n, { min: r, max: i, step: a })
        ),
        s = o;
      ((o.__background = document.createElement(`div`)),
        (o.__foreground = document.createElement(`div`)),
        Q.bind(o.__background, `mousedown`, c),
        Q.bind(o.__background, `touchstart`, d),
        Q.addClass(o.__background, `slider`),
        Q.addClass(o.__foreground, `slider-fg`));
      function c(e) {
        (document.activeElement.blur(),
          Q.bind(window, `mousemove`, l),
      ...
      function l(e) {
        ...
        return (s.setValue(Pc(e.clientX, t.left, t.right, s.__min, s.__max)), !1);
      }
      function u() {
        (Q.unbind(window, `mousemove`, l),
          Q.unbind(window, `mouseup`, u),
          s.__onFinishChange && s.__onFinishChange.call(s, s.getValue()));
      }
      function d(e) {
        e.touches.length === 1 &&
          (Q.bind(window, `touchmove`, f), Q.bind(window, `touchend`, p), f(e));
      }
      function f(e) {
        var t = e.touches[0].clientX,
          n = s.__background.getBoundingClientRect();
        s.setValue(Pc(t, n.left, n.right, s.__min, s.__max));
      }
      function p() {
        (Q.unbind(window, `touchmove`, f),
          Q.unbind(window, `touchend`, p),
          s.__onFinishChange && s.__onFinishChange.call(s, s.getValue()));
      }
      return (
        o.updateDisplay(),
  ...
  Ic = (function (e) {
    ...
    function t(e, n, r) {
      ...
      return (
        ...
        (i.__button.innerHTML = r === void 0 ? `Fire` : r),
        Q.bind(i.__button, `click`, function (e) {
          return (e.preventDefault(), a.fire(), !1);
        }),
        Q.addClass(i.__button, `button`),
  ...
  Lc = (function (e) {
    ...
    function t(e, n) {
      mc(this, t);
      var r = vc(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n));
      ((r.__color = new yc(r.getValue())), (r.__temp = new yc(0)));
      var i = r;
      ((r.domElement = document.createElement(`div`)),
        Q.makeSelectable(r.domElement, !1),
        ...
        Q.bind(r.__input, `blur`, u),
        Q.bind(r.__selector, `mousedown`, function () {
          Q.addClass(this, `drag`).bind(window, `mouseup`, function () {
            Q.removeClass(i.__selector, `drag`);
          });
        }),
        Q.bind(r.__selector, `touchstart`, function () {
          Q.addClass(this, `drag`).bind(window, `touchend`, function () {
            Q.removeClass(i.__selector, `drag`);
          });
        }));
      var a = document.createElement(`div`);
      (Z.extend(r.__selector.style, {
        width: `122px`,
        height: `102px`,
        padding: `3px`,
        backgroundColor: `#222`,
        ...
        Z.extend(r.__saturation_field.style, {
          width: `100px`,
          height: `100px`,
        ...
        Z.extend(a.style, { width: `100%`, height: `100%`, background: `none` }),
        zc(a, `top`, `rgba(0,0,0,0)`, `#000`),
        Z.extend(r.__hue_field.style, {
          width: `15px`,
          height: `100px`,
          border: `1px solid #555`,
          cursor: `ns-resize`,
        ...
        Q.bind(r.__saturation_field, `mousedown`, o),
        Q.bind(r.__saturation_field, `touchstart`, o),
        Q.bind(r.__field_knob, `mousedown`, o),
        Q.bind(r.__field_knob, `touchstart`, o),
        Q.bind(r.__hue_field, `mousedown`, s),
        Q.bind(r.__hue_field, `touchstart`, s));
      function o(e) {
        (f(e),
          Q.bind(window, `mousemove`, f),
          Q.bind(window, `touchmove`, f),
          Q.bind(window, `mouseup`, c),
          Q.bind(window, `touchend`, c));
      }
      function s(e) {
        (p(e),
          Q.bind(window, `mousemove`, p),
          Q.bind(window, `touchmove`, p),
          Q.bind(window, `mouseup`, l),
          Q.bind(window, `touchend`, l));
      }
      function c() {
        (Q.unbind(window, `mousemove`, f),
          Q.unbind(window, `touchmove`, f),
          Q.unbind(window, `mouseup`, c),
          Q.unbind(window, `touchend`, c),
          d());
      }
      function l() {
        (Q.unbind(window, `mousemove`, p),
          Q.unbind(window, `touchmove`, p),
          Q.unbind(window, `mouseup`, l),
          Q.unbind(window, `touchend`, l),
          d());
      }
      function u() {
        var e = uc(this.value);
      ...
      hc(t, [
        {
          ...
          value: function () {
            ...
            if (e !== !1) {
              ...
              (Z.each(
                ...
                function (n) {
                  if (
                    !Z.isUndefined(e[n]) &&
                    !Z.isUndefined(this.__color.__state[n]) &&
                ...
                t && Z.extend(this.__color.__state, e));
            }
            ...
            (Z.extend(this.__field_knob.style, {
              ...
              (this.__temp.s = 1),
              (this.__temp.v = 1),
              zc(this.__saturation_field, `left`, `#fff`, this.__temp.toHexString()),
...
function zc(e, t, n, r) {
  ((e.style.background = ``),
    Z.each(Rc, function (i) {
      e.style.cssText +=
        `background: ` + i + `linear-gradient(` + t + `, ` + n + ` 0%, ` + r + ` 100%); `;
    }));
}
function Bc(e) {
  ((e.style.background = ``),
...
var Vc = {
  ...
  Hc = `<div id="dg-save" class="dg dialogue">
  ...
  Uc = function (e, t) {
    ...
    return Z.isArray(arguments[2]) || Z.isObject(arguments[2])
      ? new Oc(e, t, arguments[2])
      : Z.isNumber(n)
        ? Z.isNumber(arguments[2]) && Z.isNumber(arguments[3])
          ? Z.isNumber(arguments[4])
            ? new Fc(e, t, arguments[2], arguments[3], arguments[4])
            : new Fc(e, t, arguments[2], arguments[3])
          : Z.isNumber(arguments[4])
            ? new Nc(e, t, { min: arguments[2], max: arguments[3], step: arguments[4] })
            : new Nc(e, t, { min: arguments[2], max: arguments[3] })
        : Z.isString(n)
          ? new kc(e, t)
          : Z.isFunction(n)
            ? new Ic(e, t, ``)
  ...
  Kc = (function () {
    function e() {
      (mc(this, e),
        ...
        Q.makeFullscreen(this.backgroundElement),
            ...
            var e = this,
              t = function t() {
                ((e.domElement.style.display = `none`),
                  ...
                  Q.unbind(e.domElement, `webkitTransitionEnd`, t),
                  Q.unbind(e.domElement, `transitionend`, t),
                  Q.unbind(e.domElement, `oTransitionEnd`, t));
              };
            (Q.bind(this.domElement, `webkitTransitionEnd`, t),
              Q.bind(this.domElement, `transitionend`, t),
              Q.bind(this.domElement, `oTransitionEnd`, t),
        ...
        },
        {
          ...
          value: function () {
            ((this.domElement.style.left =
              window.innerWidth / 2 - Q.getWidth(this.domElement) / 2 + `px`),
              (this.domElement.style.top =
                window.innerHeight / 2 - Q.getHeight(this.domElement) / 2 + `px`));
          },
        },
      ]),
      e
...
var Jc = `dg`,
  ...
  $ = function e(t) {
    ...
    ((this.domElement = document.createElement(`div`)),
      ...
      Q.addClass(this.domElement, Jc),
      (this.__folders = {}),
      (this.__controllers = []),
      (this.__rememberedObjects = []),
      (this.__rememberedObjectIndecesToControllers = []),
      (this.__listening = []),
      (r = Z.defaults(r, { closeOnTop: !1, autoPlace: !0, width: e.DEFAULT_WIDTH })),
      (r = Z.defaults(r, { resizable: r.autoPlace, hideable: r.autoPlace })),
      Z.isUndefined(r.load) ? (r.load = { preset: Zc }) : r.preset && (r.load.preset = r.preset),
      Z.isUndefined(r.parent) && r.hideable && rl.push(this),
      (r.resizable = Z.isUndefined(r.parent) && r.resizable),
      r.autoPlace && Z.isUndefined(r.scrollable) && (r.scrollable = !0));
    var i = Qc && localStorage.getItem(ul(this, `isLocal`)) === `true`,
      a = void 0,
      o = void 0;
    if (
      (Object.defineProperties(this, {
        ...
        preset: {
          ...
          set: function (e) {
            (n.parent ? (n.getRoot().preset = e) : (r.load.preset = e), _l(this), n.revert());
          },
        },
        width: {
          get: function () {
        ...
        closed: {
          ...
          set: function (t) {
            ((r.closed = t),
              r.closed ? Q.addClass(n.__ul, e.CLASS_CLOSED) : Q.removeClass(n.__ul, e.CLASS_CLOSED),
              this.onResize(),
        ...
        useLocalStorage: {
          ...
          set: function (e) {
            Qc &&
              ((i = e),
              e ? Q.bind(window, `unload`, a) : Q.unbind(window, `unload`, a),
              localStorage.setItem(ul(n, `isLocal`), e));
          },
        },
      }),
      Z.isUndefined(r.parent))
    ) {
      if (
        ((this.closed = r.closed || !1),
        Q.addClass(this.domElement, e.CLASS_MAIN),
        Q.makeSelectable(this.domElement, !1),
        Qc && i)
      ) {
        n.useLocalStorage = !0;
        var s = localStorage.getItem(ul(this, `gui`));
        s && (r.load = JSON.parse(s));
      }
      ((this.__closeButton = document.createElement(`div`)),
        (this.__closeButton.innerHTML = e.TEXT_CLOSED),
        Q.addClass(this.__closeButton, e.CLASS_CLOSE_BUTTON),
        r.closeOnTop
          ? (Q.addClass(this.__closeButton, e.CLASS_CLOSE_TOP),
            this.domElement.insertBefore(this.__closeButton, this.domElement.childNodes[0]))
          : (Q.addClass(this.__closeButton, e.CLASS_CLOSE_BOTTOM),
      ...
      (Q.addClass(c, `controller-name`),
        (o = il(n, c)),
        Q.addClass(this.__ul, e.CLASS_CLOSED),
        Q.addClass(o, `title`),
        Q.bind(o, `click`, function (e) {
    ...
    (r.autoPlace &&
      (Z.isUndefined(r.parent) &&
        ((el &&=
          ...
          Q.addClass(tl, Jc),
          Q.addClass(tl, e.CLASS_AUTO_PLACE_CONTAINER),
          document.body.appendChild(tl),
          !1)),
        tl.appendChild(this.domElement),
        Q.addClass(this.domElement, e.CLASS_AUTO_PLACE)),
      this.parent || hl(n, r.width)),
      (this.__resizeHandler = function () {
        n.onResizeDebounced();
      }),
      Q.bind(window, `resize`, this.__resizeHandler),
      ...
      (a = function () {
        Qc &&
          localStorage.getItem(ul(n, `isLocal`)) === `true` &&
          localStorage.setItem(ul(n, `gui`), JSON.stringify(n.getSaveObject()));
      }),
...
(($.toggleHide = function () {
  ((nl = !nl),
    Z.each(rl, function (e) {
      e.domElement.style.display = nl ? `none` : ``;
    }));
}),
  ($.CLASS_AUTO_PLACE = `a`),
  ...
  ($.CLASS_CLOSE_TOP = `close-top`),
  ($.CLASS_CLOSE_BOTTOM = `close-bottom`),
  ($.CLASS_DRAG = `drag`),
  ($.DEFAULT_WIDTH = 245),
  ...
  ($._keydownHandler = function (e) {
    document.activeElement.type !== `text` &&
      (e.which === Yc || e.keyCode === Yc) &&
      $.toggleHide();
  }),
  Q.bind(window, `keydown`, $._keydownHandler, !1),
  Z.extend($.prototype, {
    add: function (e, t) {
      return ll(this, e, t, { factoryArgs: Array.prototype.slice.call(arguments, 2) });
    },
    addColor: function (e, t) {
      return ll(this, e, t, { color: !0 });
    },
    remove: function (e) {
    ...
    destroy: function () {
      ...
      (Z.each(this.__folders, function (t) {
        ...
        Q.unbind(window, `keydown`, $._keydownHandler, !1),
        al(this));
    },
    addFolder: function (e) {
      if (this.__folders[e] !== void 0)
        throw Error(`You already have a folder in this GUI by the name "` + e + `"`);
      ...
      var n = new $(t);
      this.__folders[e] = n;
      var r = il(this, n.domElement);
      return (Q.addClass(r, `folder`), n);
    },
    ...
    onResize: function () {
      var e = this.getRoot();
      if (e.scrollable) {
        var t = Q.getOffset(e.__ul).top,
          n = 0;
        (Z.each(e.__ul.childNodes, function (t) {
          (e.autoPlace && t === e.__save_row) || (n += Q.getHeight(t));
        }),
          window.innerHeight - t - Xc < n
            ? (Q.addClass(e.domElement, $.CLASS_TOO_TALL),
              (e.__ul.style.height = window.innerHeight - t - Xc + `px`))
            : (Q.removeClass(e.domElement, $.CLASS_TOO_TALL), (e.__ul.style.height = `auto`)));
      }
      (e.__resize_handle &&
        Z.defer(function () {
    ...
    getSaveObject: function () {
      ...
      return (
        ...
        this.__rememberedObjects.length > 0 &&
          ((e.preset = this.preset), (e.remembered ||= {}), (e.remembered[this.preset] = gl(this))),
        (e.folders = {}),
    ...
    save: function () {
      (this.load.remembered || (this.load.remembered = {}),
        (this.load.remembered[this.preset] = gl(this)),
        ol(this, !1),
        this.saveToLocalStorageIfPossible());
    },
    saveAs: function (e) {
      (this.load.remembered ||
        ((this.load.remembered = {}), (this.load.remembered[Zc] = gl(this, !0))),
        (this.load.remembered[e] = gl(this)),
        (this.preset = e),
        dl(this, e, !0),
        this.saveToLocalStorageIfPossible());
    },
    revert: function (e) {
      (Z.each(
        this.__controllers,
        function (t) {
          (this.getRoot().load.remembered ? cl(e || this.getRoot(), t) : t.setValue(t.initialValue),
    ...
    listen: function (e) {
      ...
      (this.__listening.push(e), t && vl(this.__listening));
    },
...
function al(e) {
  (Q.unbind(window, `resize`, e.__resizeHandler),
    e.saveToLocalStorageIfPossible && Q.unbind(window, `unload`, e.saveToLocalStorageIfPossible));
}
function ol(e, t) {
...
function sl(e, t, n) {
  if (
    ...
    Z.extend(n, {
      options: function (t) {
        if (arguments.length > 1) {
          ...
          return (
            n.remove(),
            ll(e, n.object, n.property, { before: r, factoryArgs: [Z.toArray(arguments)] })
          );
        }
        if (Z.isArray(t) || Z.isObject(t)) {
          var i = n.__li.nextElementSibling;
          return (n.remove(), ll(e, n.object, n.property, { before: i, factoryArgs: [t] }));
        }
      },
      name: function (e) {
    ...
    var r = new Nc(n.object, n.property, { min: n.__min, max: n.__max, step: n.__step });
    (Z.each([`updateDisplay`, `onChange`, `onFinishChange`, `step`, `min`, `max`], function (e) {
      var t = n[e],
        i = r[e];
      n[e] = r[e] = function () {
    ...
    ((n.min = Z.compose(i, n.min)), (n.max = Z.compose(i, n.max)));
  } else
    n instanceof Dc
      ? (Q.bind(t, `click`, function () {
          Q.fakeEvent(n.__checkbox, `click`);
        }),
        Q.bind(n.__checkbox, `click`, function (e) {
          e.stopPropagation();
        }))
      : n instanceof Ic
        ? (Q.bind(t, `click`, function () {
            Q.fakeEvent(n.__button, `click`);
          }),
          Q.bind(t, `mouseover`, function () {
            Q.addClass(n.__button, `hover`);
          }),
          Q.bind(t, `mouseout`, function () {
            Q.removeClass(n.__button, `hover`);
          }))
        : n instanceof Lc &&
          (Q.addClass(t, `color`),
          (n.updateDisplay = Z.compose(function (e) {
            return ((t.style.borderLeftColor = n.__color.toString()), e);
          }, n.updateDisplay)),
          n.updateDisplay());
  n.setValue = Z.compose(function (t) {
    return (e.getRoot().__preset_select && n.isModified() && ol(e.getRoot(), !0), t);
  }, n.setValue);
}
function cl(e, t) {
  var n = e.getRoot(),
  ...
  if (r !== -1) {
    ...
    if (
      (i === void 0 && ((i = {}), (n.__rememberedObjectIndecesToControllers[r] = i)),
      (i[t.property] = t),
...
function ll(e, t, n, r) {
  ...
  var i = void 0;
  if (r.color) i = new Lc(t, n);
  else {
    var a = [t, n].concat(r.factoryArgs);
    i = Uc.apply(e, a);
  }
  (r.before instanceof Sc && (r.before = r.before.__li), cl(e, i), Q.addClass(i.domElement, `c`));
  var o = document.createElement(`span`);
  (Q.addClass(o, `property-name`), (o.innerHTML = i.property));
  var s = document.createElement(`div`);
  (s.appendChild(o), s.appendChild(i.domElement));
  var c = il(e, s, r.before);
  return (
    Q.addClass(c, $.CLASS_CONTROLLER_ROW),
    i instanceof Lc ? Q.addClass(c, `color`) : Q.addClass(c, pc(i.getValue())),
    sl(e, c, i),
...
function pl(e) {
  ...
  (Q.addClass(e.domElement, `has-save`),
    e.__ul.insertBefore(t, e.__ul.firstChild),
    Q.addClass(t, `save-row`));
  var n = document.createElement(`span`);
  ((n.innerHTML = `&nbsp;`), Q.addClass(n, `button gears`));
  var r = document.createElement(`span`);
  ((r.innerHTML = `Save`), Q.addClass(r, `button`), Q.addClass(r, `save`));
  var i = document.createElement(`span`);
  ((i.innerHTML = `New`), Q.addClass(i, `button`), Q.addClass(i, `save-as`));
  var a = document.createElement(`span`);
  ((a.innerHTML = `Revert`), Q.addClass(a, `button`), Q.addClass(a, `revert`));
  var o = (e.__preset_select = document.createElement(`select`));
  if (
    (e.load && e.load.remembered
      ? Z.each(e.load.remembered, function (t, n) {
          dl(e, n, n === e.preset);
        })
      : dl(e, Zc, !1),
    ...
    ((l.style.display = `block`),
      localStorage.getItem(ul(e, `isLocal`)) === `true` && c.setAttribute(`checked`, `checked`),
      fl(e, s),
      Q.bind(c, `change`, function () {
        ((e.useLocalStorage = !e.useLocalStorage), fl(e, s));
      }));
  }
  var u = document.getElementById(`dg-new-constructor`);
  (Q.bind(u, `keydown`, function (e) {
    e.metaKey && (e.which === 67 || e.keyCode === 67) && $c.hide();
  }),
    Q.bind(n, `click`, function () {
      ((u.innerHTML = JSON.stringify(e.getSaveObject(), void 0, 2)),
        $c.show(),
        u.focus(),
        u.select());
    }),
    Q.bind(r, `click`, function () {
      e.save();
    }),
    Q.bind(i, `click`, function () {
...
function ml(e) {
  ...
  ((e.__resize_handle = document.createElement(`div`)),
    Z.extend(e.__resize_handle.style, {
      width: `6px`,
      marginLeft: `-3px`,
      height: `200px`,
      cursor: `ew-resize`,
  ...
  function r() {
    (Q.removeClass(e.__closeButton, $.CLASS_DRAG),
      Q.unbind(window, `mousemove`, n),
      Q.unbind(window, `mouseup`, r));
  }
  function i(i) {
    return (
      i.preventDefault(),
      (t = i.clientX),
      Q.addClass(e.__closeButton, $.CLASS_DRAG),
      Q.bind(window, `mousemove`, n),
      Q.bind(window, `mouseup`, r),
      !1
    );
  }
  (Q.bind(e.__resize_handle, `mousedown`, i),
    Q.bind(e.__closeButton, `mousedown`, i),
...
function gl(e, t) {
  var n = {};
  return (
    Z.each(e.__rememberedObjects, function (r, i) {
      var a = {},
        o = e.__rememberedObjectIndecesToControllers[i];
      (Z.each(o, function (e, n) {
...
`,
  ...
  xl = o((e, t) => {
    function n(e) {
      var t = e.length,
        ...
        r = Array(t),
        i;
      for (i = t; i > 0; i--) ((r[i - 1] = n), (n *= e[i - 1]));
      return { stride: r, data: new Uint32Array(n) };
    }
    function r(e) {
      var t = e.length,
        n = 1,
        ...
        a,
        o;
      for (a = t; a > 0; a--) ((r[a - 1] = n), (n *= e[a - 1]));
      for (o = 0; o < n; o++) i.push([]);
      return { stride: r, data: i };
    }
    t.exports = { integer: n, array: r };
  }),
  Sl = o((e, t) => {
    t.exports = n;
    function n(e, t) {
      ...
      for (l = 0; l < r; l += 2)
        ((a = -2 * Math.log(t())),
          ...
          (n[l + 1] = o * Math.sin(s)));
      if (e % 2) {
        var u = Math.sqrt(-2 * Math.log(t())) * Math.cos(2 * Math.PI * t());
        ((n[e - 1] = u), (i += u ** 2));
      }
      for (c = 1 / Math.sqrt(i), l = 0; l < e; ++l) n[l] *= c;
      return n;
    }
  }),
  Cl = o((e, t) => {
    t.exports = function (e, t) {
      ((e ||= 1), (t ||= 2));
      for (var n = e * 2 + 1, r = n ** +t - 1, i = Array(r), a = 0; a < r; a++)
        for (var o = (i[a] = Array(t)), s = a < r / 2 ? a : a + 1, c = 1; c <= t; c++) {
          var l = s % n ** +c;
          ((o[c - 1] = l / n ** (c - 1) - e), (s -= l));
        }
      return i;
    ...
    function r(e) {
      ...
      for (
        t = t.filter(function (t) {
          for (var n = 0, r = 0; r < e; r++) n += Math.max(0, Math.abs(t[r]) - 1) ** 2;
          return n < e;
        }),
          i = 0;
        i < e;
  ...
  Tl = o((e, t) => {
    var n = xl().integer,
      ...
      i = wl();
    function a(e, t) {
      for (var n = 0, r = 0; r < e.length; r++) n += (e[r] - t[r]) ** 2;
      return n;
    }
    function o(e, t) {
      if (typeof e.distanceFunction == `function`)
        throw Error(
      ...
      ((this.shape = e.shape),
        ...
        (this.maxDistance = e.maxDistance || e.minDistance * 2),
        (this.maxTries = Math.ceil(Math.max(1, e.tries || 30))),
        (this.rng = t || Math.random));
      for (var r = 0, a = 0; a < this.shape.length; a++) r = Math.max(r, this.shape[a]);
      var o = 1e-14 * Math.max(1, (r / 128) | 0);
      ((this.dimension = this.shape.length),
        (this.squaredMinDistance = this.minDistance * this.minDistance),
        (this.minDistancePlusEpsilon = this.minDistance + o),
        ...
        (this.neighbourhood = i(this.dimension)),
        (this.currentPoint = null),
        (this.processList = []),
        (this.samplePoints = []),
        (this.gridShape = []));
      for (var a = 0; a < this.dimension; a++)
        this.gridShape.push(Math.ceil(this.shape[a] / this.cellSize));
      this.grid = n(this.gridShape);
    }
    ((o.prototype.shape = null),
      (o.prototype.dimension = null),
      (o.prototype.minDistance = null),
      (o.prototype.maxDistance = null),
      (o.prototype.minDistancePlusEpsilon = null),
      (o.prototype.squaredMinDistance = null),
      (o.prototype.deltaDistance = null),
      (o.prototype.cellSize = null),
      (o.prototype.maxTries = null),
      (o.prototype.rng = null),
      (o.prototype.neighbourhood = null),
      (o.prototype.currentPoint = null),
      (o.prototype.processList = null),
      (o.prototype.samplePoints = null),
      (o.prototype.gridShape = null),
      (o.prototype.grid = null),
      (o.prototype.addRandomPoint = function () {
        for (var e = Array(this.dimension), t = 0; t < this.dimension; t++)
          e[t] = this.rng() * this.shape[t];
        return this.directAddPoint(e);
      }),
      (o.prototype.addPoint = function (e) {
        var t,
          n = !0;
        if (e.length === this.dimension)
          for (t = 0; t < this.dimension && n; t++) n = e[t] >= 0 && e[t] < this.shape[t];
        else n = !1;
        return n ? this.directAddPoint(e) : null;
      }),
      (o.prototype.directAddPoint = function (e) {
        var t = 0,
          n = this.grid.stride,
          r;
        for (this.processList.push(e), this.samplePoints.push(e), r = 0; r < this.dimension; r++)
          t += ((e[r] / this.cellSize) | 0) * n[r];
        return ((this.grid.data[t] = this.samplePoints.length), e);
      }),
      (o.prototype.inNeighbourhood = function (e) {
        var t = this.dimension,
          ...
          s,
          c;
        for (r = 0; r < this.neighbourhood.length; r++) {
          for (i = 0, o = 0; o < t; o++) {
            if (
              ((s = ((e[o] / this.cellSize) | 0) + this.neighbourhood[r][o]),
              s < 0 || s >= this.gridShape[o])
            ) {
              i = -1;
              break;
            }
          ...
          if (
            i !== -1 &&
            this.grid.data[i] !== 0 &&
            ((c = this.samplePoints[this.grid.data[i] - 1]), a(e, c) < this.squaredMinDistance)
          )
            return !0;
        }
        return !1;
      ...
      (o.prototype.next = function () {
        for (var e, t, n, i, a, o, s; this.processList.length > 0;) {
          for (
            this.currentPoint === null && (this.currentPoint = this.processList.shift()),
              i = this.currentPoint,
              e = 0;
            e < this.maxTries;
            e++
            ...
            for (
              o = !0,
                n = this.minDistancePlusEpsilon + this.deltaDistance * this.rng(),
                this.dimension === 2
                  ? ((t = this.rng() * Math.PI * 2), (a = [Math.cos(t), Math.sin(t)]))
                  : (a = r(this.dimension, this.rng)),
                s = 0;
              o && s < this.dimension;
              s++
            )
              ((a[s] = i[s] + a[s] * n), (o = a[s] >= 0 && a[s] < this.shape[s]));
            if (o && !this.inNeighbourhood(a)) return this.directAddPoint(a);
          }
          e === this.maxTries && (this.currentPoint = null);
        }
        return null;
      }),
      ...
      (o.prototype.getAllPoints = function () {
        return this.samplePoints;
      }),
      (o.prototype.getAllPointsWithDistance = function () {
        throw Error(
  ...
  El = o((e, t) => {
    ...
    function o(e, t) {
      ...
      ((this.shape = e.shape),
        ...
        (this.maxDistance = e.maxDistance || e.minDistance * 2),
        (this.maxTries = Math.ceil(Math.max(1, e.tries || 30))),
        (this.distanceFunction = e.distanceFunction),
        (this.bias = Math.max(0, Math.min(1, e.bias || 0))),
        (this.rng = t || Math.random));
      for (var r = 0, a = 0; a < this.shape.length; a++) r = Math.max(r, this.shape[a]);
      var o = 1e-14 * Math.max(1, (r / 128) | 0);
      ((this.dimension = this.shape.length),
    ...
    ((o.prototype.shape = null),
      ...
      (o.prototype.cellSize = null),
      (o.prototype.maxTries = null),
      (o.prototype.distanceFunction = null),
      (o.prototype.bias = null),
      (o.prototype.rng = null),
      (o.prototype.neighbourhood = null),
      (o.prototype.currentPoint = null),
      (o.prototype.currentDistance = null),
      (o.prototype.processList = null),
      (o.prototype.samplePoints = null),
      (o.prototype.sampleDistance = null),
      (o.prototype.gridShape = null),
      (o.prototype.grid = null),
      (o.prototype.addRandomPoint = function () {
        for (var e = Array(this.dimension), t = 0; t < this.dimension; t++)
      ...
      (o.prototype.directAddPoint = function (e) {
        var t = 0,
          ...
          i;
        for (
          this.processList.push(r),
            this.samplePoints.push(e),
            this.sampleDistance.push(this.distanceFunction(e)),
            i = 0;
          i < this.dimension;
          i++
        )
          t += ((e[i] / this.cellSize) | 0) * n[i];
        return (this.grid.data[t].push(r), e);
      }),
      (o.prototype.inNeighbourhood = function (e) {
        var t = this.dimension,
          n = this.grid.stride,
        ...
        for (r = 0; r < this.neighbourhood.length; r++) {
          ...
          if (i !== -1 && this.grid.data[i].length > 0)
            for (var d = 0; d < this.grid.data[i].length; d++) {
              ((c = this.samplePoints[this.grid.data[i][d]]),
                (l = this.sampleDistance[this.grid.data[i][d]]));
              var f = Math.min(l, u),
                p = f + (Math.max(l, u) - f) * this.bias;
              if (a(e, c) < this.minDistance + this.deltaDistance * p) return !0;
            }
        }
        return !1;
      }),
      (o.prototype.next = function () {
        for (var e, t, n, i, a, o, s, c; this.processList.length > 0;) {
          if (this.currentPoint === null) {
            var l = this.processList.shift();
            ((this.currentPoint = this.samplePoints[l]),
              (this.currentDistance = this.sampleDistance[l]));
          }
          for (i = this.currentPoint, a = this.currentDistance, e = 0; e < this.maxTries; e++) {
            for (
              s = !0,
                n = this.minDistancePlusEpsilon + this.deltaDistance * (a + (1 - a) * this.bias),
                this.dimension === 2
                  ? ((t = this.rng() * Math.PI * 2), (o = [Math.cos(t), Math.sin(t)]))
                  : (o = r(this.dimension, this.rng)),
                c = 0;
              s && c < this.dimension;
              c++
            )
              ((o[c] = i[c] + o[c] * n), (s = o[c] >= 0 && o[c] < this.shape[c]));
            if (s && !this.inNeighbourhood(o)) return this.directAddPoint(o);
          }
          e === this.maxTries && (this.currentPoint = null);
        }
        return null;
      ...
      (o.prototype.getAllPointsWithDistance = function () {
        var e = Array(this.samplePoints.length),
          t = 0,
          n = 0,
          r;
        for (t = 0; t < this.samplePoints.length; t++) {
          for (r = Array(this.dimension + 1), n = 0; n < this.dimension; n++)
            r[n] = this.samplePoints[t][n];
          ((r[this.dimension] = this.sampleDistance[t]), (e[t] = r));
        }
        return e;
      }),
      (o.prototype.reset = function () {
  ...
  Dl = o((e, t) => {
    ...
    function i(e, t) {
      ((this.shape = e.shape),
        typeof e.distanceFunction == `function`
          ? (this.implementation = new r(e, t))
          : (this.implementation = new n(e, t)));
    }
    ((i.prototype.implementation = null),
      (i.prototype.addRandomPoint = function () {
        return this.implementation.addRandomPoint();
      }),
      (i.prototype.addPoint = function (e) {
        return this.implementation.addPoint(e);
      }),
      ...
      (i.prototype.getAllPoints = function () {
        return this.implementation.getAllPoints();
      }),
      (i.prototype.getAllPointsWithDistance = function () {
  ...
  Ol = class {
    ...
    getVal(e) {
      var t = e * this.scale,
        ...
        r = t - n,
        i = r * r * (3 - 2 * r),
        a = n % this.MAX_VERTICES_MASK,
        o = (a + 1) % this.MAX_VERTICES_MASK;
