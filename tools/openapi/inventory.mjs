export const modules = [
  ...
  },
  {
    ...
    scenarios: ['SC-R1-BOOK-01', 'SC-R1-BOOK-02', 'SC-R1-BOOK-03', 'SC-R1-BOOK-04', 'SC-R1-PAY-01', 'SC-R1-PAY-02', 'SC-R1-RESCHEDULE-01', 'SC-R1-RESCHEDULE-02'], operations: [
      ...
      get('/booking/availability', 'getBookingAvailability', 'slot_hold.create', { queryParameters: [{ name: 'patientId', required: true, schema: { type: 'string', format: 'uuid' } }] }),
      ...
      get('/appointments/{appointmentId}', 'getAppointment', 'appointment.read', { response: 'PatientAppointment' }),
      create('/appointments/{appointmentId}/actions/reschedule-slot-holds', 'createRescheduleSlotHold', 'appointment.reschedule', { body: 'RescheduleSlotHoldRequest', response: 'SlotHold' }),
      ...
      action('/appointments/{appointmentId}/actions/reschedule-top-up', 'createRescheduleTopUp', 'appointment.reschedule', { idempotent: true, body: 'RescheduleTopUpRequest', response: 'PaymentIntent' }),
      action('/appointments/{appointmentId}/actions/cancel', 'cancelAppointment', 'appointment.cancel', { idempotent: true, body: 'CancelAppointmentRequest', response: 'PatientAppointment' }),
